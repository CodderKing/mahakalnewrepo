...
class PushNotificationService
{
    public function getMessageKeyData(string $userType):array
    {
        ...
        $puja = [
            'puja_order_pending_message',
            'puja_order_schedule_time',
            'puja_order_live_now',
            'puja_order_share_now',
            'puja_order_completed',
            'puja_order_cancel',
            'puja_order_rejected',
        ];
        $counselling = [
            'counselling_order_pending_message',
            'counselling_order_completed',
            'counselling_order_cancel',
        ];
        $offlinepuja = [
            'offlinepuja_order_pending_message',
            'offlinepuja_order_completed',
            'offlinepuja_order_cancel',
        ];
