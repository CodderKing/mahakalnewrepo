...
class BusinessSettingsController extends BaseController
{
    ...
    public function getView(): View
    {
        ...
        $businessSetting = [
            ...
            'email_top_bar' => $this->getSettings(object: $web, type: 'email_top_bar')->value ?? '',
            'email_bottom_bar' => $this->getSettings(object: $web, type: 'email_bottom_bar')->value ?? '',
        ];
    ...
    public function updateSettings(BusinessSettingRequest $request, BusinessSettingService $businessSettingService): RedirectResponse
    {
        ...
        // email image
        $Emailtopimage = $this->businessSettingRepo->getFirstWhere(params: ['type' => 'email_top_bar']);
        if ($request->has('email_top_bar')) {
            $EmailtopImage = $this->updateFile(dir: 'company/', oldImage: $Emailtopimage['value'], format: 'webp', image: $request->file('email_top_bar'));
            $this->businessSettingRepo->updateWhere(params: ['type' => 'email_top_bar'], data: ['value' => $EmailtopImage]);
        }
        $Emailbottomimage = $this->businessSettingRepo->getFirstWhere(params: ['type' => 'email_bottom_bar']);
        if ($request->has('email_bottom_bar')) {
            $EmailbottomImage = $this->updateFile(dir: 'company/', oldImage: $Emailbottomimage['value'], format: 'webp', image: $request->file('email_bottom_bar'));
            $this->businessSettingRepo->updateWhere(params: ['type' => 'email_bottom_bar'], data: ['value' => $EmailbottomImage]);
        }
        ...
        Helpers::editDeleteLogs('System Setting', 'Business Setting', 'Update');
        return back();
    }
    ...
    public function updateAppSettings(Request $request): RedirectResponse
    {
        ...
        Toastr::success(translate('updated_successfully'));
        Helpers::editDeleteLogs('Business Setting', 'App Setting', 'Update');
        return back();
    }
    ...
    public function updateCookieSetting(Request $request): RedirectResponse
    {
        ...
        Helpers::editDeleteLogs('Business Setting', 'Cookie', 'Update');
    ...
    public function getOtpSetupView(): View
    {
        ...
        return view(BusinessSettings::OTP_SETUP[VIEW], compact(
            'maximumOtpHit',
            'otpResendTime',
            'temporaryBlockTime',
            'maximumLoginHit',
    ...
    public function updateOtpSetup(Request $request): RedirectResponse
    {
        ...
        Helpers::editDeleteLogs('Business Setting', 'OTP Setup', 'Update');
        return back();
    }
    ...
    public function updateAnalytics(Request $request): RedirectResponse
    {
        ...
        Helpers::editDeleteLogs('Business Setting', 'Business Setup', 'Update');
        return back();
    }
    ...
    public function updateProductSettings(Request $request): RedirectResponse
    {
        ...
        Toastr::success(translate('updated_successfully'));
        Helpers::editDeleteLogs('Business Setting', 'Product', 'Update');
        return back();
    }
    ...
    public function updateAnnouncement(Request $request): RedirectResponse
    {
        ...
        Helpers::editDeleteLogs('Business Setting', 'Announcement', 'Update');
        return back();
    }
}