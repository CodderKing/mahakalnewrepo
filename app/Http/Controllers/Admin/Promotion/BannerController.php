...
class BannerController extends BaseController
{
    ...
    public function getListView(Request $request): View
    {
        ...
        return view(Banner::LIST[VIEW],  compact('banners', 'categories','shops', 'brands', 'products', 'appsections', 'isReactActive', 'bannerTypes'));
    }
    ...
    public function getUpdateView($id): View
    {
        ...
        $appsections = $this->appsectionRepo->getListWhere(dataLimit: 'all');
        $products = $this->productRepo->getListWithScope(scope:'active', dataLimit: 'all');
        return view(Banner::UPDATE[VIEW], compact('banner', 'categories','shops', 'brands', 'products', 'appsections', 'bannerTypes'));
    }
