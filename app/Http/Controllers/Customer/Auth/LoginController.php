...
class LoginController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        if ($request->user_id == 'user@mahakal.com') {
            Toastr::error(translate('User_cannot_login_with_this_invalid_email_ID'));
            return back();
        }
        ...
        if (isset($user) && auth('customer')->attempt(['phone' => $user['phone'], 'password' => $request['password']], $remember)) {
