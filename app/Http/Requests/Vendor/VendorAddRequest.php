...
class VendorAddRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shop_name' => 'required_if:from_submit,seller',
            'shop_address' => 'required_if:from_submit,seller',
            'logo'              => 'required_if:from_submit,seller|mimes: jpg,jpeg,png,webp,gif,bmp,tif,tiff',
            'banner'            => 'required_if:from_submit,seller|mimes: jpg,jpeg,png,webp,gif,bmp,tif,tiff',
            'bottom_banner'     => 'mimes: jpg,jpeg,png,webp,gif,bmp,tif,tiff',
            "from_submit" =>   "required|in:seller,event,tour,trust"
        ];
    }
