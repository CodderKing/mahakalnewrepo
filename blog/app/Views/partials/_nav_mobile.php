...
<a href="https://mahakal.rizrv.in/" aria-label="logo"><img src="<?= getMobileLogo($generalSettings); ?>" alt="logo" width="<?= $generalSettings->logo_mobile_width; ?>" height="<?= $generalSettings->logo_mobile_height; ?>"></a>
</div>
...
<a href="https://mahakal.rizrv.in/" aria-label="logo"><img src="<?= getLogo($generalSettings); ?>" alt="logo" width="<?= $generalSettings->logo_desktop_width; ?>" height="<?= $generalSettings->logo_desktop_height; ?>"></a>
</div>
...
<div class="col-sm-12">
<ul class="navbar-nav">
<li class="nav-item"><a href="https://mahakal.rizrv.in/" class="nav-link"><?= trans("home"); ?></a></li>
...
<?= csrf_field(); ?>
<?php if ($darkMode == 1): ?>
<button type="submit" name="theme_mode" value="light" class="btn-switch-mode-mobile" aria-label="light mode mobile">
...
<?php else: ?>
<button type="submit" name="theme_mode" value="dark" class="btn-switch-mode-mobile" aria-label="dark mode mobile">
