...
$('.action-display-data').on('change', function () {
    ...
    let elementResourceAppsection = $('#resource-appsection');
    ...
    elementResourceAppsection.hide();

    // Show the relevant resource based on selection
    if (data === 'product') {
    ...
    } else if (data === 'appsection') {
        elementResourceAppsection.show();
    }
});
