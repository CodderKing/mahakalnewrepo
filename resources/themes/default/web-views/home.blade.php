...
@section('title', translate('Dharmik Saamagri Ki Online Kharidaari Karein – Mahakal Pooja Shop'))

@push('css_or_js')
    <meta name="description"
        content="Mahakal.com shop par pooja saamagri, rudraksh, bhagwan ki moortiyan, jaap mala, havan saamagri aur anya dharmik vastuayein online kharidein. Vishwasniya aur shuddh utpaad ab ghar baithe.">
...
@section('content')
    <div class="__inline-61">
        ...
        @if (isset($main_section_banner))
            <div class="container-fluid rtl pt-2 px-0 px-md-3">
            ...
            <div class="container rtl d-md-block d-none">
                <div class="row g-3 mt-3">
                    ...
                    @else
                        ...
                        <div class="col-md-6">
                            <div
                                class="{{ count($footerBannerGroup2) > 1 ? 'owl-carousel owl-theme footer-banner-slider' : '' }}">
        ...
        @if ($web_config['brand_setting'] && $brands->count() > 0)
            <section class="container-fluid rtl pt-4">
