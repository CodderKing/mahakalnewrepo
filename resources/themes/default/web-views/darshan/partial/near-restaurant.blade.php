            ...
            <div class="col-12 p-0 feature-product">
                <div class="carousel-wrap p-1">
                    <div class="owl-carousel owl-theme nearby-slider-1">
                        @foreach($nearbyRestaurant as $restaurant)
                        <div>
                            <div class="product-single-hover shadow-none rtl">
                                <div class="overflow-hidden position-relative">
                                    <div class="inline_product clickable">
                                        <a href="{{route('near-restaurant',[base64_encode($restaurant['id'])])}}">                                            
                                            <img src="{{ getValidImage(path: 'storage/app/public/temple/restaurant/'.$restaurant['image'], type: 'product') }}" alt="">
                                        </a>

                                        <div class="quick-view">
                                            <a  href="{{route('near-restaurant',[base64_encode($restaurant['id'])])}}" class="btn-circle stopPropagation action-product-quick-view">
                                    ...
                                    @php 
                                    $createquery = \App\Models\RestaurantReview::where('restaurant_id',$restaurant['id'])->where('status',1);
                                    ...
                                    @endif
                                        <div>
                                            <a href="{{route('near-restaurant',[base64_encode($restaurant['id'])])}}" class="text-capitalize fw-semibold">
                                                {{ ucwords($restaurant['restaurant_name']) }}
                                            </a>
                                        </div>
                                    </div>
                                </div>
