                                            ...
                                            <td class="for-tab-img">
                                                <div class="media gap-3 align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <small> ({{translate('return_pending')}}) </small>
                                                        <br>
                                                        @elseif($detail->refund_request == 2)
                                                        <small> ({{translate('return_approved')}}) </small>
                                                        <br>
                                                        @elseif($detail->refund_request == 3)
                                                        <small> ({{translate('return_rejected')}}) </small>
                                                        <br>
                                                        @elseif($detail->refund_request == 4)
                                                        <small> ({{translate('return_refunded')}}) </small>
                                                        <br>
                                                        @endif
                                                        @if($detail->variant)
                                                        <br>
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2 mt-2">
                                                            ...
                                                            ?>
                                                            @if($order->order_type == 'default_type')
                                                            @if($order->order_status=='delivered' && $detail->product->product_refund == '0')
                                                            ...
                                                            data-toggle="modal"
                                                            data-target="#refundModal{{$detail->id}}">{{translate('return')}}</button>
                                                            @endif
                                                            @endif
                                                            @endif
                                                        </div>
...
<script>
function reasonGet() {
var selectBox = document.getElementById("reason_name");
var selectedText = selectBox.options[selectBox.selectedIndex].text;
document.getElementById("reason-data").value = selectedText;
}
</script>
@endpush