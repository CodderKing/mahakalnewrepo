                ...
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <form action="{{ route('submit-anushthan-review', $order['order_id']) }}" method="post"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="youtubeLink">{{ translate('YouTube Video Link (Optional)') }} </label>
