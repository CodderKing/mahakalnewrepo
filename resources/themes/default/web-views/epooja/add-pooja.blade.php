...
@section('content')
    ...
    <div class="w-full h-full sticky md:top-[68px] top-0 z-20">
        <div class="bg-bar w-full d-none d-md-block">
    ...
    <div class="__inline-23">
        <div class="container rtl mb-3 py-3" id="cart-summary">
            @php
                ...
                $productLeads = \App\Models\ProductLeads::where('leads_id', $leadsGet->id)->get();
                $totalProductPrice = $productLeads->sum(function ($item) {
                    return $item->product_price * $item->qty;
                });
                $finalPrice = (int)$leadsGet->package_price + $totalProductPrice;
                        ...
                        <div class="card-header" id="">
                            <div class="details __h-100">
                                ...
                                <div class="d-flex justify-content-between"> {{ $leadsGet->package_name }}
                                    <span
                                        class=""><b>{{ webCurrencyConverter(amount: $leadsGet['package_price']) }}</b></span>
                                </div>
                                <div class="stm">
                        ...
                        <div class="__cart-total __cart-total_sticky">
                                ...
                                @else
                                    ...
                                    <div class="pt-2">
                                        <form class="needs-validation" action="javascript:" method="post" novalidate
                                            ...
                                            <div class="invalid-feedback">{{ translate('please_provide_coupon_code') }}
                                            </div>
                                        </form>
                                    </div>
                            ...
                            @if ($digital_payment['status'] == 1)
                                @foreach ($payment_gateways_list as $payment_gateway)
                                    <form method="post" class="digital_payment checkout-form"
                                       ...
                                       <div class="Details">
                                            ...
                                            <input type="hidden" name="external_redirect_link" value="{{ url('/service-web-payment') }}">
                                            ...
                                            <input type="hidden" name="service_id" value="{{ $leadsDetails['service']['id'] }}">
                                            ...
                                            @php
                                                $discountedAmount = session()->has('coupon_discount_pooja')
                                                ...
                                                <div>
                                                    <div>
                                                        <h1 class="flash-product-title"
                                                            style="font-weight: 600;line-height: 20px !important;margin-bottom: 5px;">
                                                            {{ $product['name'] }}
                                                        </h1>
                                                    </div>
                                                    <div
    ...
    {{-- <input type="hidden" id="poojaProductRoute" value=""> --}}
    {{-- Vishesh Prashadam --}}
@endsection
@push('script')
