...
@php
    $activeRoutes = [
        ...
        'account-service-order-details*',
        'account-service-pandit-details*',
        'account-service-order-track*',
        'account-service-certificate*',
        'account-service-sankalp*',
        'account-offlinepooja-order-details*',
        'account-vip-order-details*',
        'account-vip-pandit-details*',
        'account-vip-order-track*',
        'account-vip-certificate*',
        'account-vip-sankalp*',
        'account-counselling-order-details*',
        'account-counselling-order-track*',
        'account-anushthan-order-details*',
        'account-anushthan-pandit-details*',
        'account-anushthan-order-track*',
        'account-anushthan-certificate*',
        'account-anushthan-sankalp*',
        'account-chadhava-order-details*',
        'account-chadhava-pandit-details*',
        'account-chadhava-order-track*',
        'account-order-product*',
        'account-order-pooja*',
        'account-order-vip*',
        'account-order-anushthan*',
        'account-order-chadhava*',
        'account-order-counselling*',
        'account-chadhava-sankalp*',
        'account-order-event*',
        'account-order-donate*',
        'account-order-tour*',
    ];
...
<div class="col-lg-3">
    ...
    <div class="__customer-sidebar user-profile-aside" id="shop-sidebar">
        ...
        <div>
            <div>
                <div class="widget-title">
                    <a class="{{ Request::is('user-account*') ? 'active-menu' : '' }}"
            ...
            <div class="widget-title">
                <a class="nav-link1 collapsed text-truncate border-0 {{ $isActive ? 'active-menu' : '' }}"
                    href="submenu1" data-toggle="collapse" data-target="#submenu1">
                    <i class="fa fa-list"></i>
                    <span class="d-sm-inline">{{ translate('my_order') }}</span></a>
                <div class="collapse" id="submenu1" aria-expanded="false">
                    <ul class="flex-column pl-2 nav">
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('all_orders') }}</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-product') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('Product_order') }}</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-pooja') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('Pooja_order') }}
                                    ({{ \App\Models\Service_order::where(['customer_id' => auth('customer')->id(), 'type' => 'pooja'])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-vip') }}"><i
                                    class="fa-brands fa-first-order-alt"></i>
                                <span class="aside-link">{{ translate('Vip_order') }}
                                    ({{ \App\Models\Service_order::where(['customer_id' => auth('customer')->id(), 'type' => 'vip'])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-anushthan') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('Anushthan_order') }}
                                    ({{ \App\Models\Service_order::where(['customer_id' => auth('customer')->id(), 'type' => 'anushthan'])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-chadhava') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('Chadhava_order') }}
                                    ({{ \App\Models\Chadhava_orders::where(['customer_id' => auth('customer')->id(), 'type' => 'chadhava'])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-offlinepooja') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('pandit_order') }}
                                    ({{ \App\Models\OfflinePoojaOrder::where(['customer_id' => auth('customer')->id()])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-counselling') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('Counsellings_order') }}
                                    ({{ \App\Models\Service_order::where(['customer_id' => auth('customer')->id(), 'type' => 'counselling'])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-event') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('Event_order') }}
                                    ({{ \App\Models\EventOrder::where(['user_id' => auth('customer')->id()])->whereIn('transaction_status', ['1', '2', '3'])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-tour') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span class="aside-link">
                                    {{ translate('Tour_Order') }}
                                    ({{ \App\Models\TourOrder::where(['user_id' => auth('customer')->id()])->whereIn('amount_status', [1, 2, 3])->count() }})</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="py-0" href="{{ route('account-order-donate') }}"><i
                                    class="fa-brands fa-first-order-alt"></i> <span
                                    class="aside-link">{{ translate('donate_order') }}
                                    ({{ \App\Models\DonateAllTransaction::whereIn('type', ['donate_trust', 'donate_ads'])->where('amount_status', 1)->where(['user_id' => auth('customer')->id()])->count() }})</span></a>
                        </li>
        ...
        <div>
            <div>
                <div class="widget-title">
                    <a class="{{ Request::is('saved-kundali') ? 'active-menu' : '' }}"
                        href="{{ route('saved.kundali') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
            ...
            <div>
                <div class="widget-title">
                    <a class="{{ Request::is('saved-paid-kundali') ? 'active-menu' : '' }}"
                        href="{{ route('saved.paid.kundali') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M17.2917 2.49984V18.3332C17.2917 18.5648 17.1633 18.7773 16.9583 18.8857C16.7533 18.994 16.5058 18.9798 16.3142 18.849L14.235 17.4298L12.2692 18.8407C12.0333 19.0107 11.7117 18.9948 11.4933 18.8032L10 17.4973L8.50666 18.8032C8.28833 18.9948 7.96666 19.0107 7.73083 18.8407L5.765 17.4298L3.68583 18.849C3.49416 18.9798 3.24666 18.994 3.04166 18.8857C2.83666 18.7773 2.70833 18.5648 2.70833 18.3332V2.49984C2.70833 1.69484 3.36083 1.0415 4.16666 1.0415H15.8333C16.6392 1.0415 17.2917 1.69484 17.2917 2.49984ZM6.66666 8.95817H13.3333C13.6783 8.95817 13.9583 8.67817 13.9583 8.33317C13.9583 7.98817 13.6783 7.70817 13.3333 7.70817H6.66666C6.32166 7.70817 6.04166 7.98817 6.04166 8.33317C6.04166 8.67817 6.32166 8.95817 6.66666 8.95817ZM6.66666 5.62484H13.3333C13.6783 5.62484 13.9583 5.34484 13.9583 4.99984C13.9583 4.65484 13.6783 4.37484 13.3333 4.37484H6.66666C6.32166 4.37484 6.04166 4.65484 6.04166 4.99984C6.04166 5.34484 6.32166 5.62484 6.66666 5.62484ZM6.66666 12.2915H10C10.345 12.2915 10.625 12.0115 10.625 11.6665C10.625 11.3215 10.345 11.0415 10 11.0415H6.66666C6.32166 11.0415 6.04166 11.3215 6.04166 11.6665C6.04166 12.0115 6.32166 12.2915 6.66666 12.2915Z"
            ...
            <div class="widget-title">
                <a class="{{ Request::is('saved-kundali-milan') ? 'active-menu' : '' }}"
                    href="{{ route('saved.kundali.milan') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M17.2917 2.49984V18.3332C17.2917 18.5648 17.1633 18.7773 16.9583 18.8857C16.7533 18.994 16.5058 18.9798 16.3142 18.849L14.235 17.4298L12.2692 18.8407C12.0333 19.0107 11.7117 18.9948 11.4933 18.8032L10 17.4973L8.50666 18.8032C8.28833 18.9948 7.96666 19.0107 7.73083 18.8407L5.765 17.4298L3.68583 18.849C3.49416 18.9798 3.24666 18.994 3.04166 18.8857C2.83666 18.7773 2.70833 18.5648 2.70833 18.3332V2.49984C2.70833 1.69484 3.36083 1.0415 4.16666 1.0415H15.8333C16.6392 1.0415 17.2917 1.69484 17.2917 2.49984ZM6.66666 8.95817H13.3333C13.6783 8.95817 13.9583 8.67817 13.9583 8.33317C13.9583 7.98817 13.6783 7.70817 13.3333 7.70817H6.66666C6.32166 7.70817 6.04166 7.98817 6.04166 8.33317C6.04166 8.67817 6.32166 8.95817 6.66666 8.95817ZM6.66666 5.62484H13.3333C13.6783 5.62484 13.9583 5.34484 13.9583 4.99984C13.9583 4.65484 13.6783 4.37484 13.3333 4.37484H6.66666C6.32166 4.37484 6.04166 4.65484 6.04166 4.99984C6.04166 5.34484 6.32166 5.62484 6.66666 5.62484ZM6.66666 12.2915H10C10.345 12.2915 10.625 12.0115 10.625 11.6665C10.625 11.3215 10.345 11.0415 10 11.0415H6.66666C6.32166 11.0415 6.04166 11.3215 6.04166 11.6665C6.04166 12.0115 6.32166 12.2915 6.66666 12.2915Z"
        ...
        <div>
            <div class="widget-title">
                <a class="{{ Request::is('saved-paid-kundali-milan') ? 'active-menu' : '' }}"
                    href="{{ route('saved.paid.kundali.milan') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M17.2917 2.49984V18.3332C17.2917 18.5648 17.1633 18.7773 16.9583 18.8857C16.7533 18.994 16.5058 18.9798 16.3142 18.849L14.235 17.4298L12.2692 18.8407C12.0333 19.0107 11.7117 18.9948 11.4933 18.8032L10 17.4973L8.50666 18.8032C8.28833 18.9948 7.96666 19.0107 7.73083 18.8407L5.765 17.4298L3.68583 18.849C3.49416 18.9798 3.24666 18.994 3.04166 18.8857C2.83666 18.7773 2.70833 18.5648 2.70833 18.3332V2.49984C2.70833 1.69484 3.36083 1.0415 4.16666 1.0415H15.8333C16.6392 1.0415 17.2917 1.69484 17.2917 2.49984ZM6.66666 8.95817H13.3333C13.6783 8.95817 13.9583 8.67817 13.9583 8.33317C13.9583 7.98817 13.6783 7.70817 13.3333 7.70817H6.66666C6.32166 7.70817 6.04166 7.98817 6.04166 8.33317C6.04166 8.67817 6.32166 8.95817 6.66666 8.95817ZM6.66666 5.62484H13.3333C13.6783 5.62484 13.9583 5.34484 13.9583 4.99984C13.9583 4.65484 13.6783 4.37484 13.3333 4.37484H6.66666C6.32166 4.37484 6.04166 4.65484 6.04166 4.99984C6.04166 5.34484 6.32166 5.62484 6.66666 5.62484ZM6.66666 12.2915H10C10.345 12.2915 10.625 12.0115 10.625 11.6665C10.625 11.3215 10.345 11.0415 10 11.0415H6.66666C6.32166 11.0415 6.04166 11.3215 6.04166 11.6665C6.04166 12.0115 6.32166 12.2915 6.66666 12.2915Z"
                    ...
                    <a class="{{ Request::is('wallet') ? 'active-menu' : '' }}" href="{{ route('wallet') }}">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <path
                                    d="M19.3167 14V14.0008C19.3153 14.2625 19.2127 14.5136 19.0304 14.7014C18.8821 14.8541 18.6904 14.9554 18.4833 14.9928V16.8998V16.9H18.3333C18.3337 17.1255 18.2895 17.3489 18.2033 17.5573C18.1172 17.7658 17.9907 17.9551 17.8313 18.1146C17.6718 18.2741 17.4824 18.4005 17.274 18.4867C17.0656 18.5728 16.8422 18.617 16.6167 18.6167L19.3167 14ZM19.3167 14L19.3167 9.9L19.3167 9.89922C19.3153 9.63748 19.2127 9.38641 19.0304 9.19861C18.8821 9.04589 18.6904 8.94464 18.4833 8.90726L19.3167 14ZM2.55022 18.7667H16.6164L0.833328 16.9C0.833001 17.1255 0.877179 17.3489 0.963333 17.5573C1.04949 17.7658 1.17592 17.9551 1.3354 18.1146C1.49487 18.2741 1.68424 18.4005 1.89267 18.4867C2.10109 18.5728 2.32447 18.617 2.55 18.6167V18.7667H2.55022ZM0.68333 7.00012V16.8999L2.55 5.28334C2.32447 5.28301 2.10109 5.32719 1.89267 5.41334C1.68424 5.49949 1.49487 5.62593 1.3354 5.7854C1.17592 5.94488 1.04949 6.13425 0.963333 6.34267C0.877179 6.5511 0.833001 6.77447 0.833328 7H0.68333V7.00012ZM5.6226 2.54738L5.62265 2.5474L5.62408 2.54352C5.63688 2.50879 5.65676 2.4771 5.68247 2.45047C5.70788 2.42416 5.73842 2.40336 5.77219 2.38936C5.84366 2.36199 5.92271 2.36196 5.99419 2.38925L12.583 5.13334H11.341L6.43264 3.50001C6.4323 3.49989 6.43195 3.49977 6.4316 3.49964C6.29347 3.45186 6.1422 3.4593 6.0094 3.52043C5.87627 3.58171 5.77205 3.69219 5.71864 3.82868L5.71844 3.82921L5.21386 5.13334H4.58822L5.6226 2.54738ZM6.58096 4.74587L7.75227 5.13334H6.43399L6.58096 4.74587ZM17.35 16.8999C17.3498 17.0943 17.2725 17.2808 17.135 17.4183C16.9975 17.5558 16.811 17.6332 16.6165 17.6333H2.55014C2.35566 17.6332 2.16921 17.5558 2.0317 17.4183C1.89418 17.2808 1.81685 17.0943 1.81666 16.8999L1.81666 7.00052C1.81805 6.80633 1.89581 6.62048 2.03314 6.48315C2.17046 6.34583 2.35631 6.26807 2.55049 6.26667H16.6162C16.8104 6.26807 16.9962 6.34583 17.1335 6.48315C17.2709 6.62052 17.3487 6.80644 17.35 7.0007C17.35 7.0008 17.35 7.00089 17.35 7.00098L17.35 8.88334H13.75C12.9367 8.88334 12.1566 9.20643 11.5815 9.78154C11.0064 10.3567 10.6833 11.1367 10.6833 11.95C10.6833 12.7633 11.0064 13.5434 11.5815 14.1185C12.1566 14.6936 12.9367 15.0167 13.75 15.0167H17.35V16.8999ZM18.1833 13.8833H13.75C13.2372 13.8833 12.7455 13.6796 12.3829 13.3171C12.0204 12.9545 11.8167 12.4628 11.8167 11.95C11.8167 11.4373 12.0204 10.9455 12.3829 10.5829C12.7454 10.2205 13.2369 10.0168 13.7494 10.0167C13.7496 10.0167 13.7498 10.0167 13.75 10.0167L18.1833 10.0489V13.8833Z"
                                    fill="currentColor" stroke="currentColor" stroke-width="0.3" />
                                <path
                                    d="M13.75 10.7002C13.5028 10.7002 13.2611 10.7735 13.0555 10.9109C12.85 11.0482 12.6898 11.2434 12.5952 11.4718C12.5005 11.7002 12.4758 11.9516 12.524 12.1941C12.5723 12.4365 12.6913 12.6593 12.8661 12.8341C13.0409 13.0089 13.2637 13.1279 13.5061 13.1762C13.7486 13.2244 13.9999 13.1997 14.2284 13.105C14.4568 13.0104 14.652 12.8502 14.7893 12.6447C14.9267 12.4391 15 12.1974 15 11.9502C15 11.6187 14.8683 11.3007 14.6339 11.0663C14.3995 10.8319 14.0815 10.7002 13.75 10.7002ZM13.75 12.3669C13.6676 12.3669 13.587 12.3424 13.5185 12.2966C13.45 12.2509 13.3966 12.1858 13.3651 12.1096C13.3335 12.0335 13.3253 11.9497 13.3413 11.8689C13.3574 11.7881 13.3971 11.7138 13.4554 11.6556C13.5136 11.5973 13.5879 11.5576 13.6687 11.5415C13.7495 11.5255 13.8333 11.5337 13.9095 11.5652C13.9856 11.5968 14.0507 11.6502 14.0964 11.7187C14.1422 11.7872 14.1667 11.8678 14.1667 11.9502C14.1667 12.0607 14.1228 12.1667 14.0446 12.2448C13.9665 12.323 13.8605 12.3669 13.75 12.3669Z"
                                    fill="currentColor" />
                                <path
                                    d="M5.83333 8.19987C5.83333 8.31038 5.78943 8.41636 5.71129 8.4945C5.63315 8.57264 5.52717 8.61654 5.41666 8.61654H3.74999C3.63949 8.61654 3.53351 8.57264 3.45537 8.4945C3.37723 8.41636 3.33333 8.31038 3.33333 8.19987C3.33333 8.08936 3.37723 7.98338 3.45537 7.90524C3.53351 7.8271 3.63949 7.7832 3.74999 7.7832H5.41666C5.52717 7.7832 5.63315 7.8271 5.71129 7.90524C5.78943 7.98338 5.83333 8.08936 5.83333 8.19987Z"
                                    fill="currentColor" />
                                <path
                                    d="M7.5 9.86686C7.5 9.97737 7.4561 10.0833 7.37796 10.1615C7.29982 10.2396 7.19384 10.2835 7.08333 10.2835H3.74999C3.63949 10.2835 3.53351 10.2396 3.45537 10.1615C3.37723 10.0833 3.33333 9.97737 3.33333 9.86686C3.33333 9.75636 3.37723 9.65037 3.45537 9.57223C3.53351 9.49409 3.63949 9.4502 3.74999 9.4502H7.08333C7.19384 9.4502 7.29982 9.49409 7.37796 9.57223C7.4561 9.65037 7.5 9.75636 7.5 9.86686Z"
                                    fill="currentColor" />
                            </svg>
                        </span>
                        <span class="aside-link">
        ...
        <div>
            <div class="widget-title">
                <a class="{{ Request::is('chat/seller') ? 'active-menu' : '' }} {{ Request::is('chat/delivery-man') ? 'active-menu' : '' }}"
                    href="{{ route('chat', ['type' => $business_mode == 'multi' ? 'seller' : 'delivery-man']) }}">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <g clip-path="url(#clip0_776_10801)">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M10.0032 0.00341797C15.526 0.00341797 20.0032 4.47947 20.0032 10.0048C20.0032 15.5273 15.526 20.0034 10.0032 20.0034C4.48041 20.0034 0.00326538 15.5275 0.00326538 10.0048C0.00326538 4.47947 4.48069 0.00341797 10.0032 0.00341797ZM3.75323 13.7922L8.25713 9.92588L3.75514 6.06123C3.75389 6.07194 3.75324 6.08271 3.75319 6.0935L3.75323 13.7922ZM8.67315 10.2831L4.12803 14.185H15.8787L11.3332 10.2831L10.1794 11.2736C10.1299 11.3159 10.0668 11.339 10.0017 11.3386C9.93653 11.3382 9.8737 11.3144 9.82467 11.2715L8.67315 10.2831ZM11.7494 9.92588L16.2533 13.7922V6.0935C16.2534 6.08271 16.2527 6.07192 16.2512 6.06123L11.7494 9.92596L11.7494 9.92588ZM4.30834 5.82178L10.0032 10.7105L15.698 5.82178H4.30834Z"
                                    fill="currentColor" />
                            </g>
                            <defs>
        ...
        <div>
            <div class="widget-title">
                <a class="{{ Request::is('history-order*') ? 'active-menu' : '' }}"
                    ...
                    <span class="aside-link">{{ translate('history_order') }} </span>
                </a>
            </div>
        </div>
        <div>
            <div class="widget-title">
                <a class="{{ Request::is('feedback*') ? 'active-menu' : '' }}" href="{{ route('feedback') }}">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path
                    ...
                    <span class="aside-link">{{ translate('feedback') }} </span>
                </a>
            </div>
        </div>
        <div class="d-lg-none">
