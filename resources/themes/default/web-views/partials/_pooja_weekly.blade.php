    ...
    <div class="portfolio-wrapper">
        ...
        <div class="card">
            <span class="for-discount-value pooja-badge p-1 pl-2 pr-2 font-bold fs-13">
                <span class="direction-ltr blink d-block">{{ $poojaD->service->category->name }}
                </span>
            </span>
            @if (!empty($poojaD->service->thumbnail))
            ...
            <div class="card-body newpadding">
                <p class="pooja-heading underborder two-lines-only">{{ strtoupper($poojaD->service->pooja_heading) }}
                </p>
                ...
                <p class="card-text mt-2 mb-2 two-lines-only">{{ $poojaD->service->short_benifits }}</p>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="pooja-calendar">{{ 10000 + $poojaD->pooja_order_review_count }}+ Devotees</span>
                    </div>
