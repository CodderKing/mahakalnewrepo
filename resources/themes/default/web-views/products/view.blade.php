                            ...
                            <div class="__p-25-10 w-100 pt-4">
                                <label class="w-100 opacity-75 text-nowrap for-sorting d-block mb-0 ps-0" for="sorting">
                                    <select class="form-control custom-select" id="searchByFilterValue">
                                        ...
                                        <option
                                            value="{{route('products-slug',['slug'=> $data['slug']??'','data_from'=>'best-selling','page'=>1])}}" {{isset($data['data_from'])!=null?$data['data_from']=='best-selling'?'selected':'':''}}>{{translate('best_selling_product')}}</option>products-slug
                                        <option
                                            value="{{route('products-slug',['slug'=> $data['slug']??'','data_from'=>'top-rated','page'=>1])}}" {{isset($data['data_from'])!=null?$data['data_from']=='top-rated'?'selected':'':''}}>{{translate('top_rated')}}</option>
                                        <option
                                            value="{{route('products-slug',['slug'=> $data['slug']??'','data_from'=>'most-favorite','page'=>1])}}" {{isset($data['data_from'])!=null?$data['data_from']=='most-favorite'?'selected':'':''}}>{{translate('most_favorite')}}</option>
                                        <option
                                            value="{{route('products-slug',['slug'=> $data['slug']??'','data_from'=>'featured_deal','page'=>1])}}" {{isset($data['data_from'])!=null?$data['data_from']=='featured_deal'?'selected':'':''}}>{{translate('featured_deal')}}</option>
                                    </select>
                                </label>
                            </div>
                                    ...
                                    @foreach(\App\Utils\BrandManager::get_active_brands() as $brand)
                                        <div
                                            ...
                                            <li class="flex-between __inline-39 get-view-by-onclick"
                                                data-link="{{ route('products-slug',['slug'=> $brand['slug'],'data_from'=>'brand','page'=>1]) }}">
                                            ...
                                            <div class="card-header flex-between">
                                                <div>
                                                    <label class="for-hover-label cursor-pointer get-view-by-onclick"
                                                        data-link="{{ route('products-slug',['slug'=> $category['slug'],'data_from'=>'category','page'=>1]) }}">
                                                        {{$category['name']}}
                                                    </label>
                                                </div>
                                                            ...
                                                            @foreach($child->childes as $ch)
                                                                <div class="card-header">
                                                                    <label
                                                                        ...
                                                                        data-link="{{ route('products-slug',['slug'=> $ch['slug'],'data_from'=>'category','page'=>1]) }}">
                                                                        {{$ch['name']}}
                                                                    </label>
                                                                </div>
                                                            @endforeach
