...
@section('title', translate('Anushthan |Order Place'))
                    ...
                    @if(auth('customer')->check() || session('guest_id'))
                        <div class="card-body">
                            ...
                            <h6 class="font-black fw-bold text-center">
                                {{ translate('Anushthan_Successfully_Requested')}}!
                            </h6>
                            <h6 class="font-black fw-bold text-center">
                            ...
                            <div class="row mt-4">
                                ...
                                <a href="{{ auth('customer')->check() ? route('account-anushthan-order-details', ['order_id' => $orderId]) : route('customer.auth.login') }}" class="btn btn--primary mb-3 text-center">{{ translate('track_order') }}</a>
