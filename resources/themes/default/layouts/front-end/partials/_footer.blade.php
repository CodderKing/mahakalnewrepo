...
/*.search_icon a:hover i  {
    ...
    .mobile-button {
        ...
        border-radius: 10px;
        cursor: pointer;
        box-shadow: 0px 0px 13px 0px #5e5e5e;
    }
...
<div class="__inline-9 rtl">
    <div class="d-flex justify-content-center text-center custom-light-primary-color text-md-start p-4">
        <div class="col-md-3 d-flex justify-content-center">
            <div>
                <a href="{{ route('about-us') }}">
                    <div class="text-center">
                        <img class="size-60"
                            src="{{ theme_asset(path: 'public/assets/front-end/png/about-company.png') }}" alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
        ...
        <!-- <div class="sticky-icon">
           <a href="javascript:void(0);" class="myicon mobile-button" onclick="openStoreLink()"><i class="fa-brands fa-android"> </i> Open App </a>   
        </div> -->
        <!--End Sticky Icon-->
    </div>
                    ...
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                        ...
                        @if ($web_config['ios']['status'] || $web_config['android']['status'])
                            <div class="mt-4 pt-lg-4">
                                <h6 class="text-uppercase font-weight-bold footer-header text-center">
                                    {{ translate('download_our_app') }}
                                </h6>
                            </div>
                        @endif

                        <div class="text-center pr-lg-4 mb-2 d-none d-sm-block justify-content-center">
                            <img src="{{ getValidImage(path: 'storage/app/public/qrcodes/mahakal-qr-code.png', type: 'logo') }}" alt="" style="height: 119px;">
                        </div>
    ...
    $flash_deals = \App\Models\FlashDeal::where(['status' => 1, 'deal_type' => 'flash_deal'])->whereDate('start_date', '<=', date('Y-m-d'))->whereDate('end_date', '>=', date('Y-m-d'))->first()
                            ...
                            <div class="col-sm-4 col-6 footer-padding-bottom text-start">
                                <h6 class="text-uppercase mobile-fs-12 font-semi-bold footer-header">
                                    {{ translate('account_&_shipping_info') }}</h6>
                            ...
                            <div class="col-sm-5 footer-padding-bottom offset-max-sm--1 pb-3 pb-sm-0">
                                <div class="mb-2">
                                    ...
                                    <div class="text-center text-sm-start mobile-fs-12">
                                        {{ translate('subscribe_to_our_new_channel_to_get_latest_updates') }}</div>
                                </div>
                                    ...
                                    <div class="col-12 start_address ">
                                        ...
                                        <div>
                                            <a class="widget-list-link"
                                                ...
                                                <span><i class="fa fa-envelope  me-2 mt-2 mb-2"></i>
                                                    {{ getWebConfig(name: 'company_email') }} </span>
                                            </a>
                                        </div>
                                        <div class="pe-3">
                                            @if (auth('customer')->check())
        ...
        <div class="bg-white-overlay-50">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    ...
                    <div class="mt-3">
                        <h1 class="text-align-direction __text-18px text-primary" style="margin-right: 24px;">
                            {{ translate('Visitors Counts ') }}: {{ 100000 +(\App\Models\Visitor::count() ?? 0) }}</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="mobile-button-wrapper" id="openAppContainer">
            <button class="mobile-button" onclick="openStoreLink()">Open App</button>
            <button class="close-btn11" onclick="document.getElementById('openAppContainer').remove()">×</button>
        </div>
