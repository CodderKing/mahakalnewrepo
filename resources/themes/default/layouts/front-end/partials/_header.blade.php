    ...
    <div class="navbar-sticky bg-light mobile-head">
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container ">
                ...
                <div class="input-group-overlay mx-lg-4 search-form-mobile text-align-direction serBarIcon">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    @if (!request()->is('all-puja'))
                        <a class="navbar-tool navbar-stuck-toggler {{ request()->is('all-puja') ? 'show' : '' }}"
                            href="#">
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu {{ request()->is('all-puja') ? '' : 'show' }}">
            <div class="container px-10px">
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    @php(
    $categories = \App\Models\Category::with(['childes.childes'])->where('position', 0)->where('home_status', 1)->priority()->paginate(11)
)
                                        ...
                                        @if ($category->childes->count() > 0)
                                            <ul class="dropdown-menu text-align-direction">
                                                @foreach ($category['childes'] as $subCategory)
                                                    <li class="dropdown">
                                                        <a
                                                            href="{{ route('products-slug', ['slug' => $subCategory['slug'], 'data_from' => 'category', 'page' => 1]) }}">
                                                        ...
                                                        @if ($subCategory->childes->count() > 0)
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @foreach ($subCategory['childes'] as $subSubCategory)
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('products-slug', ['slug' => $subSubCategory['slug'], 'data_from' => 'category', 'page' => 1]) }}">{{ $subSubCategory['name'] }}</a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
                                                        @endif
                    ...
                    <ul class="navbar-nav">
                                ...
                                <ul class="text-align-direction dropdown-menu __dropdown-menu-sizing dropdown-menu-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} scroll-bar">
                                    @foreach (\App\Utils\BrandManager::get_active_brands() as $brand)
                                        <li class="__inline-17">
                                            <div>
                                                <a class="dropdown-item"
                                                   href="{{route('products-slug',['slug'=> $brand['slug'],'data_from'=>'brand','page'=>1])}}">
                                                    {{$brand['name']}}
                                                </a>
                                            </div>
                        ...
                        @endif --}}
                        <li class="nav-item dropdown {{ request()->is('panchang') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('panchang') }}">{{ translate('Panchang') }}</a>
                        </li>
                        {{-- <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#"
                                data-toggle="dropdown">{{ translate('Astrology') }}</a>
                            <ul class="dropdown-menu __dropdown-menu-2 text-align-direction">

                                <li class="dropdown">
                                    <div class="mobi-sty">
                                        <a class="dropdown-item"
                                            href="{{ route('counselling.index', 'consultancy') }}">
                                            <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                                <img alt=" {{ translate('counselling') }}"
                                                    src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/custalt.png') }}">
                                            </div>
                                            <span class="">
                                ...
                                <li class="dropdown">
                                    <div class="mobi-sty">
                                        <a class="dropdown-item" href="{{ route('counselling.index', 'muhurat') }}">
                                            <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                                <img alt=" {{ translate('Shubh_muhurat') }}"
                                                    src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/calendar.png') }}">
                                            </div>
                                            <span class=""> {{ translate('Shubh_muhurat') }} </span>
                                        </a>
                                    </div>
                        ...
                        <li class="nav-item dropdown {{ request()->is('counselling') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('counselling.astrology') }}">{{ translate('Astrology') }}</a>
                        </li>
                        <!-- <li class="nav-item dropdown shopping-style {{ request()->is('shop') ? 'active' : '' }}">
                            <a id="btn-glow" class="nav-link shopping-style-link"
                                href="{{ route('shop') }}">{{ translate('shop') }}</a>
                        </li> -->
                        <li class="nav-item dropdown {{ request()->is('shop') ? 'active' : '' }}">
                            <a class="nav-link"
                                href="{{ route('shop') }}">{{ translate('shop') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('all-puja') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('all-puja') }}">{{ translate('puja') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('all-chadhava') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('chadhava.all-chadhava') }}">{{ translate('chadhava') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('prashadam') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('shopView/mahakalcom-prashadam-dol7oL') }}">{{ translate('prasadam') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('tour') ? 'active' : '' }}">
                            <a class="nav-link"
                                href="{{ route('tour.index') }}">{{ translate('tour_&_travel') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('event') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('event') }}">{{ translate('events') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('donate') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('all-donate') }}">{{ translate('donation') }}</a>
                        </li>
                        <li class="nav-item dropdown {{ request()->is('pooja') ? 'active' : '' }}">
                            <a class="nav-link"
                                href="{{ route('offline.pooja.all') }}">{{ translate('book_pandit') }}</a>
                        </li>

                        <li class="nav-item dropdown">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle text-white text-max-md-dark text-uppercase ps-2"
                                    type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"><b>
                                        {{ translate('MORE') }}</b>
                                </button>
                                <div class="dropdown-menu __dropdown-menu-2 text-align-direction more-menu"
                                    aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item text-capitalize" href="{{ route('kundali-pdf.view') }}">
                                        <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                            <img alt=" {{ translate('kundali-pdf') }}"
                                                src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/Janamkundli.png') }}">
                                        </div>

                                        <span class="">
                                            {{ translate('kundali-pdf') }}
                                        </span>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item {{ request()->is('darshan') ? 'active' : '' }}"
                                        href="{{ route('darshan') }}">
                                        <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                            <img alt=" {{ translate('news') }}"
                                                src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/tour.png') }}">
                                        </div>
                                        <span class="">{{ translate('darshan') }}
                                        </span>
                                    </a>
                                    ...
                                    @if ($businessMode == 'multi')
                                        <a class="dropdown-item" href="{{ route('vendors') }}">
                                            ...
                                            <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                                <img alt=" {{ translate('news') }}"
                                                    src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/venders.png') }}">
                                            </div>
                                            <span class="">{{ translate('all_vendors') }}
                                            </span>
                                        </a>
                                    @endif
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ url('/blog') }}">
                                        <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                            <img alt=" {{ translate('kundali-pdf') }}"
                                                src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/blogs.png') }}">
                                        </div>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                            <img alt=" {{ translate('news') }}"
                                                src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/news.png') }}">
                                        </div>
                                        <span class="">
                                            {{ translate('news') }}
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('ram-shalaka') }}">
                                        <div class="__img" style="height: 21px;width:21px;margin-right: 10px;">
                                            <img alt=" {{ translate('ram_shalaka') }}"
                                                src="{{ theme_asset(path: 'public/assets/front-end/img/menu-icon/ram-salakha-icon.png') }}">
                                        </div>
                                        <span class="">
                                        ...
                                        <div class="mega_menu z-2">
                                            @foreach ($category->childes as $sub_category)
                                                <div class="mega_menu_inner">
                                                    <h6>
                                                        <a
                                                            href="{{ route('products-slug', ['slug' => $sub_category['slug'], 'data_from' => 'category', 'page' => 1]) }}">{{ $sub_category->name }}</a>
                                                    </h6>
                                                    @if ($sub_category->childes->count() > 0)
                                                        @foreach ($sub_category->childes as $sub_sub_category)
                                                            <div>
                                                                <a
                                                                    href="{{ route('products-slug', ['slug' => $sub_sub_category['slug'], 'data_from' => 'category', 'page' => 1]) }}">{{ $sub_sub_category->name }}</a>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                </div>
