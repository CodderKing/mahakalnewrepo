...
<div class="content container-fluid">
    ...
    <form class="product-form text-start" action="{{ route('tour-vendor.tour_visits.insert-tour') }}" method="POST" enctype="multipart/form-data" id="services_form">
        @csrf
        <div class="card">
            <div class="px-4 pt-3">
            ...
            <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="number_of_day[]" class="form-control @error('number_of_day.'.$loop->index) is-invalid @enderror " value="{{ old('number_of_day.'.$loop->index,1) }}" placeholder="{{ translate('number_of_day') }}" required>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class='col-md-6 form-group add_cab_append_multi'>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-5 p-0 pr-1">
                                <input type='text' class="form-control point_trigger4{{ $index }}" name="price[{{ $index }}]" value="{{ $oldPrices[$index] ?? '' }}" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );select_value(this)" data-point='point_trigger4{{ $index }}' placeholder="{{ translate('enter_Price') }}">
                            </div>
                            @if($loop->index == 0)
                            <div class="col-1 p-0">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-5 p-0 pr-1">
                                <input type='text' class="form-control point_trigger4" name="price[0]" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );select_value(this)" data-point='point_trigger4' placeholder="{{ translate('enter_Price') }}">
                            </div>
                            <div class="col-1 p-0">
                                <a class='btn btn--primary btn-sm p-1 mt-2' onclick="add_new_cab_html()"><i class='tio-add'></i></a>
                            </div>
                    ...
                    <div class='col-md-6 form-group add_package_append_multi'>
                        <div class="row">
                            <div class='col-6'>
                        ...
                        <div class="row mt-2">
                            <div class='col-6 p-0 pr-1'>
                                <select class="form-control point_pck_trigger2{{ $index }}" name="package_id[{{ $index }}]" onchange="select_value(this)" data-point='point_pck_trigger2{{ $index }}'>
                                    ...
                                    <option value="{{ $packval['id'] }}" {{ $packval['id'] == $oldPackages[$index] ? 'selected' : '' }}>{{ $packval['name'] }} -({{ $packval['seats']}} people)</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="col-5 p-0 pr-1">
                                <input type='text' class="form-control point_pack_trigger4{{ $index }}" name="pprice[{{ $index }}]" value="{{ $oldPrices[$index] ?? '' }}" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );select_value(this)" data-point='point_pack_trigger4{{ $index }}' placeholder="{{ translate('enter_Price') }}">
                            </div>
                            @if($loop->index == 0)
                            <div class="col-1 p-0">
                        ...
                        <div class="row mt-2">
                            <div class='col-6 p-0 pr-1'>
                                <select class="form-control point_trigger2" name="package_id[0]" onchange="select_value(this)" data-point='point_trigger2'>
                                    ...
                                    @if($package_list)
                                    @foreach($package_list as $packval)
                                    <option value="{{ $packval['id']}}" {{ (collect(old('package_id'))->contains($packval['id'])) ? 'selected' : '' }}>{{ $packval['name']}} -({{ $packval['seats']}} people)</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="col-5 p-0 pr-1">
                                <input type='text' class="form-control point_pack_triggers1" name="pprice[0]" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );select_value(this)" data-point='point_pack_triggers1' placeholder="{{ translate('enter_Price') }}">
                            </div>
                            <div class="col-1 p-0">
                                <a class='btn btn--primary btn-sm p-1 mt-2' onclick="add_new_package_html()"><i class='tio-add'></i></a>
                            </div>
                    ...
                    <div class='col-md-3 form-group'>
                        ...
                        <select class="form-control" name='use_date' onchange="use_date_functions(this)">
                            ...
                            <option value="3" {{((old('use_date') == 3)?'selected':'' )}}>Daily Tour(WithOut Address)</option>
                        </select>
                    </div>
...
<script type="text/javascript">
    ...
    function add_new_package_html() {
        ...
        <div class="row mt-2">
            ...
            <div class="col-5 p-0 pr-1">
                <input type='text' class="form-control   point_pack_trigger49${pointCounter_package}" name="pprice[${pointCounter_package}]" value="" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );select_value(this)" data-point='point_pack_trigger49${pointCounter_package}' placeholder="{{ translate('enter_Price') }}">
            </div>
            <div class="col-1 p-0">
                <a class='btn btn-danger btn-sm p-1 mt-2' onclick="remove_html(this)"><i class='tio-remove'></i></a>
            </div>
