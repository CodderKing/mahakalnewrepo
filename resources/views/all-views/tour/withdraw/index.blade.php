        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a class="btn btn-primary" onclick="withdrowal_models(`{{auth('tour')->user()->relation_id}}`)">Withdrowal</a>
                        </div>
                        <div class="col-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <span class="tooltip-right" title="{{ $withdrawRequest['TourVisit']['Tour']['tour_name'] ?? '' }}" data-toggle="tooltip" data-placement="right">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('tour-vendor.withdraw.withdraw-request-view', [$withdrawRequest['id']]) }}" class="btn btn--primary btn-sm">
