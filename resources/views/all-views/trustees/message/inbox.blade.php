        ...
        <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
            <a class="order-stats order-stats_confirmed">
                ...
                <span class="order-stats__title">
                    {{ \App\Models\VendorSupportTicketConv::where('created_by', 'vendor')->where('type', 'trust')->where('vendor_id',$relationEmployees)->whereNotNull('ticket_id')->count() }}
                </span>
            </a>
        </div>
        <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
            <a class="order-stats order-stats_confirmed">
                ...
                <span
                    class="order-stats__title">{{ \App\Models\VendorSupportTicketConv::where('created_by', 'vendor')->where('type', 'trust')->where('vendor_id',$relationEmployees)->where('status', 'open')->count() }}</span>
                </span>
            </a>
        </div>
        <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
            <a class="order-stats order-stats_confirmed">
                ...
                <span
                    class="order-stats__title">{{ \App\Models\VendorSupportTicketConv::where('created_by', 'vendor')->where('type', 'trust')->where('vendor_id',$relationEmployees)->where('status', 'close')->count() }}
                </span>
                </span>
            </a>
        </div>
                        ...
                        <div
                            ...
                            <div class="media gap-3">
                                ...
                                <img class="avatar avatar-lg"
                                    src="{{ getValidImage(path: 'storage/app/public/donate/trust/' . $ticket['Trust']['theme_image'] ?? '', type: 'backend-profile') }}"
                                    alt="">
                                ...
                                <form action="{{ route('trustees-vendor.messages.status') }}" method="post"
                            ...
                            <div
                                ...
                                <div class="text-nowrap">
                                    ...
                                    <a class="btn btn--primary"
                                        href="{{ route('trustees-vendor.messages.singleTicket', $ticket['id']) }}">
    ...
    <div class="modal fade add-issues" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trustees-vendor.messages.store-inbox') }}" method="post">
