...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <form action="{{ route('event-vendor.event-management.event-edit',[$getData['id']]) }}" method="post" enctype="multipart/form-data" onsubmit="return EventformSubmit()">
                <div class="card">
                    <div class="card-body">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 d-none">
                                            ...
                                            <select class="form-control all_select_data" data-point='3' name='event_organizer_id'>
                                                ...
                                                @if($organizer_list)
                                                <option value="{{ $organizer_list['id']}}" {{ (($organizer_list['id'] == old('event_organizer_id',$getData['event_organizer_id']) )?"selected":"") }}>{{ $organizer_list['organizer_name']}}</option>
                                                @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class='col-md-4 form-group'>
                                            ...
                                            <input type="number" class="form-control all_select_data days_select" data-point='7' id='days' name='days' value="{{ old('days',($getData['days']??''))}}" placeholder="{{ translate('enter_total_days_number') }}" onkeyup="create_a_venus(this)" required>
                                        </div>
                ...
                @if(Helpers::Employee_modules_permission('Event Management', 'Event List', 'Update'))
                ...
                <div class="modal-body">
                    ...
                    <div class='col-md-12 form-group add_new_packages'>
                        <div class="row">
                            ...
                            <div class="col-4">
                                <label class="title-color fw-bolder" for="Language">{{ translate('Price') }}
                                    <a class='btn btn--primary btn-sm' onclick="add_new_html()"><i class='tio-add'></i></a></label>
                            </div>
                        </div>
        ...
        language.forEach(function(item, index) {
            ...
            for (let index = 0; index < key; index++) {
                ...
                html += `<div class='col-md-3 form-group'>
                                ...
                                <input type="text" class="form-control key_pass_work getAddress_google"  ${ ((index == 0 ) ? "onkeyup='key_pass_work(this)'":"")} data-point="${index}" ${((item1 == 'hi')?'readonly':'' )} name='venue[${index}][${item1}_event_venue]' placeholder="{{ translate('enter_Event_name') }}" value='${oldVenue}'>
                                <input type="text" class="form-control key_pass_work_full_address"  ${ ((index == 0 ) ? "onkeyup='key_pass_work12(this)'":"")} data-point="${index}" name='venue[${index}][${item1}_event_venue_full_address]' placeholder="{{ translate('enter_Event_name_full_address') }}" value='${oldVenue_place}'>
                ...
                html += ` <a onclick='add_packages_seats(${index})' class="btn btn-primary mt-4 use_interested_and_not ${((inter == 1)?"d-none":"")}"><i class="tio-checkmark_circle_outlined ${((oldPackageList == '' || oldPackageList == '[]')?'d-none':'')}  check-package-list-${index}">checkmark_circle_outlined</i> add package</a>
                                <input type="hidden" name="venue[${index}][package_list]" value='${((oldPackageList == '' || oldPackageList == '[]')?'': oldPackageList )}' class="package_list${index} package_validationadd">
                            </div>`;
            }
