...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <form action="{{ route('event-vendor.event-management.store-event') }}" method="post" enctype="multipart/form-data" onsubmit="return EventformSubmit()">
                <div class="card">
                    <div class="card-body">
                        @csrf
                                ...
                                <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control all_select_data" data-point='1' name='category_id' {{$lang == $defaultLanguage? 'required':''}}>
                                        ...
                                        <div class='col-md-4 form-group d-none'>
                                            ...
                                            <select class="form-control all_select_data" data-point='2' name='organizer_by'>
                                                <option value="outside" {{ old('organizer_by') == "outside" ? 'selected' : 'selected' }}>{{ translate('outside') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="aboutEvent{{$lang}}">
                                                    ...
                                                    <textarea name='event_about[]' class='form-control ckeditor' {{$lang == $defaultLanguage? 'required':''}}> {{ old('event_about.'.$loop->index) }} </textarea>
                                                </div>
                                                <div class="tab-pane fade" id="eventSchedule{{$lang}}">
                                                    ...
                                                    <textarea name='event_schedule[]' class='form-control ckeditor' {{$lang == $defaultLanguage? 'required':''}}> {{ old('event_schedule.'.$loop->index) }} </textarea>
                                                </div>
                                                <div class="tab-pane fade" id="whyshouldyouattend{{$lang}}">
                                                    ...
                                                    <textarea name='event_attend[]' class='form-control ckeditor' {{$lang == $defaultLanguage? 'required':''}}> {{ old('event_attend.'.$loop->index) }} </textarea>
                                                </div>
                                                <div class="tab-pane fade" id="termscondition{{$lang}}">
                                                    ...
                                                    <textarea name='event_team_condition[]' class='form-control ckeditor' {{$lang == $defaultLanguage? 'required':''}}> {{ old('event_team_condition.'.$loop->index) }} </textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 d-none">
                                            <label class="title-color" for="organizer">{{ translate('event_Organizer') }}</label>
                                            <select class="form-control all_select_data" data-point='3' name='event_organizer_id' {{$lang == $defaultLanguage? 'required':''}}>
                                                @if($organizer_list)
                                                <option value="{{ $organizer_list['id']}}" selected>{{ $organizer_list['organizer_name']}}</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class='col-md-4 form-group mt-2'>
                                            <label class="title-color" for="Age_group">{{ translate('Age_group') }}</label>
                                            <input type="text" class="form-control all_select_data" data-point='4' value="{{ old('age_group') }}" name='age_group' placeholder="{{ translate('Age_group') }}" {{$lang == $defaultLanguage? 'required':''}}>
                                        </div>
                                        <div class='col-md-4 form-group mt-2'>
                                            <label class="title-color" for="Event_artist">{{ translate('Event_artist') }}</label>
                                            <select class="form-control all_select_data" data-point='5' name='event_artist' placeholder="{{ translate('Event_artist') }}" {{$lang == $defaultLanguage? 'required':''}}>
                                        ...
                                        <div class="col-md-12">
                                            <div class='col-md-4 form-group p-0 mt-2'>
                                                ...
                                                <select name="informational_status" onchange="((this.value == 1)?$('.use_interested_and_not').addClass('d-none'):$('.use_interested_and_not').removeClass('d-none'))" class="form-control all_select_data" data-point='6' {{$lang == $defaultLanguage? 'required':''}}>
                                        ...
                                        <div class='col-md-4 form-group'>
                                            ...
                                            <input type="text" class="form-control all_select_data days_select" data-point='7' value="{{ old('days') }}" name='days' placeholder="{{ translate('enter_total_days_number') }}" onkeyup="create_a_venus(this)" {{$lang == $defaultLanguage? 'required':''}}>
                                        </div>
                                        <div class='col-md-4 form-group'>
                                        ...
                                        <div class='col-md-4 form-group'>
                                            ...
                                            <input type="text" class="form-control" name='language[]' value="{{ old('language.'.$loop->index) }}" placeholder="{{ translate('Language') }}" {{$lang == $defaultLanguage? 'required':''}}>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="custom_upload_input">
                                            <input type="file" name="event_image" class="custom-upload-input-file action-upload-color-image image-preview-before-upload" id="" data-imgpreview="pre_img_viewer" accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" required>
                ...
                @if (Helpers::Employee_modules_permission('Event Management', 'Add Event', 'Add'))
                <div class="d-flex flex-wrap gap-2 justify-content-end">
                    <button type="reset" class="btn btn-secondary">{{ translate('reset') }}</button>
                    <button type="submit" class="btn btn--primary" onclick="submitClicks()">{{ translate('submit') }}</button>
                </div>
                @endif
            </form>
        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class='col-md-12 form-group add_new_packages'>
                        ...
                        <div class="row mt-2 package-row">
                            ...
                            <div class='col-4'>
                                <input type='text' class="form-control seats_no" name="seats_no[]" placeholder="{{ translate('enter_No_Of_Seats') }}"  inputmode="decimal">
                            </div>
                            <div class="col-3">
                                <input type='text' class="form-control price_no" name="price[]" placeholder="{{ translate('enter_Price') }}"  inputmode="decimal">
                            </div>
                            <div class="col-1">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function initializeDateRangePicker(isSingleDate) {
            $('.start_date_end_date').daterangepicker({
                ...
                $('.datePickers').daterangepicker({
                    ...
                    minDate: moment().startOf('day'), //start.format('YYYY-MM-DD'),
        ...
        $('.days_select').on('input', function() {
            ...
            if (!/^\d*$/.test(value)) {
                ...
                var points = $(this).data('point');
                $(`.all_select_data[data-point="${points}"]`).val($(this).val());
            }
        });
    });
    ...
    function create_a_venus(val) {
        ...
        language.forEach(function(item, index) {
            ...
            for (let index = 0; index < key; index++) {
                ...
                html += `<div class='col-md-3 form-group'>
                                ...
                                <input type="text" class="form-control key_pass_work getAddress_google"  ${ ((index == 0 ) ? "onkeyup='key_pass_work(this)'":"")} data-point="${index}" name='venue[${index}][${item1}_event_venue]'  ${((item1 == 'hi')?'readonly':'' )} placeholder="{{ translate('Please_enter_venue_address') }}" value='${oldVenue}'>
                                <input type="text" class="form-control key_pass_work_full_address"  ${ ((index == 0 ) ? "onkeyup='key_pass_work12(this)'":"")} data-point="${index}" name='venue[${index}][${item1}_event_venue_full_address]' placeholder="{{ translate('Please_enter_venue_full_address') }}" value='${oldVenue_place}'>
                ...
                html += ` <a onclick='add_packages_seats(${index})' class="btn btn-primary mt-4 use_interested_and_not ${((inter == 1)?"d-none":"")}"><i class="tio-checkmark_circle_outlined ${((oldPackageList == '')?'d-none':'')}  check-package-list-${index}">checkmark_circle_outlined</i> add package</a>
                                <input type="hidden" name="venue[${index}][package_list]" value='${oldPackageList}' class="package_list${index} package_validationadd">
                            </div>`;
            }
        ...
        $(".getAddress_google").each(function() {
            ...
            let lang = $(inputElement).closest('.row').data('lang');
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                if (place.address_components) {
                    fullAddress += place.address_components.map(comp => comp.long_name).join(', ');
                } else {
                    fullAddress = $(inputElement).val(); // fallback to user input
                }
                ...
                const points = $(inputElement).data('point');
                const langu = (lang === 'in') ? 'hi' : lang;

                if (points == 0) {
                    $('.getAddress_google').val(fullAddress);
                    $('.country_event').val(country);
                    $('.state_event').val(state);
                    $('.cities_event').val(city);
                    $('.lat_event').val(lat);
                    $('.long_event').val(lng);

                } else {
                    $(`.getAddress_google[data-point="${points}"]`).val(fullAddress);
                    ...
                    $(`.long_event[data-point="${points}"]`).val(lng);
                }
            });
        });
    ...
    function add_new_html() {
        var newRow = `
                <div class="row mt-2 package-row">
                    ...
                    <div class='col-4'>
                        <input type='text' class="form-control seats_no" name="seats_no[]" placeholder="Enter No Of Seats"  inputmode="decimal">
                    </div>
                    <div class="col-3">
                        <input type='text' class="form-control price_no" name="price[]" placeholder="Enter Price"  inputmode="decimal">
                    </div>
                    <div class="col-1">
        ...
        if (savedData) {
            ...
            data.forEach((entry, idx) => {
                ...
                newRow += `>{{ $packval['package_name']}}</option>
                    ...
                    <div class='col-4'>
                        <input type='text' class="form-control seats_no" name="seats_no[]" value="${entry.seats_no}" placeholder="Enter No Of Seats"  inputmode="decimal">
                    </div>
                    <div class="col-3">
                        <input type='text' class="form-control price_no" name="price[]" value="${entry.price_no}" placeholder="Enter Price"  inputmode="decimal">
                    </div>`;
                if (idx == 0) {
...
<script>
    ...
    function EventformSubmit() {
        ...
        if($('select[name="informational_status"]').val() == 0){
            $('.package_validationadd').each(function() {
            ...
            if (!allFilled) {
                toastr.error("Please add at least one package.");
                return false;
            }
        }
    ...
    $(document).on('input', '.price_no', function () {
    let val = $(this).val();
...
$(document).on('input', '.seats_no', function () {
    let val = $(this).val();
    val = val.replace(/[^0-9]/g, '');
    $(this).val(val);
});
