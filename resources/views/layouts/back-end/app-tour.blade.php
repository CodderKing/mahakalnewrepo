...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-tour._header')
    @include('layouts.back-end.partials-tour._side-bar')

    <main id="content" role="main" class="main pointer-event">
        @yield('content')

        @include('layouts.back-end.partials-tour._footer')

        @include('layouts.back-end.partials-tour._modals')

        @include('layouts.back-end.partials-tour._toggle-modal')
        @include('layouts.back-end._translator-for-js')
        @include('layouts.back-end.partials-tour._sign-out-modal')
