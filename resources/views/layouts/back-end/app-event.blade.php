...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-event._header')
    @include('layouts.back-end.partials-event._side-bar')

    <main id="content" role="main" class="main pointer-event">
        @yield('content')

        @include('layouts.back-end.partials-event._footer')

        @include('layouts.back-end.partials-event._modals')

        @include('layouts.back-end.partials-event._toggle-modal')
        @include('layouts.back-end._translator-for-js')
        @include('layouts.back-end.partials-event._sign-out-modal')
