...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-trustees._header')
    @include('layouts.back-end.partials-trustees._side-bar')

    <main id="content" role="main" class="main pointer-event">
        @yield('content')
        @include('layouts.back-end.partials-trustees._footer')

        @include('layouts.back-end.partials-trustees._modals')

        @include('layouts.back-end.partials-trustees._toggle-modal')
        @include('layouts.back-end._translator-for-js')
        @include('layouts.back-end.partials-trustees._sign-out-modal')
