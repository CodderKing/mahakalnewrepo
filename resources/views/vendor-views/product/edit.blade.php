                        ...
                        <div class="{{ $language != 'en' ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" {{ $language == 'en' ? 'required' : '' }} name="name[]"
                                    id="{{ $language }}_name"
                                    value="{{ $translate[$language]['name'] ?? $product['name'] }}" class="form-control"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <textarea name="description[]" class="ckeditor">{!! $translate[$language]['description'] ?? $product['details'] !!}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="generate_number" name="code" class="form-control"
                                    value="{{ $product['code'] }}" placeholder="{{ translate('123412') }}" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                    ...
                                    @foreach (units() as $unit)
                                        <option value={{ $unit }}
                                            {{ $product['unit'] == $unit ? 'selected' : '' }}>{{ $unit }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
            ...
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        ...
                        <div class="form-group m-0">
                            <label class="switcher mb-0 d-flex align-items-center">
                                <input type="checkbox" class="switcher_input toggle-switch-message" name="product_refund"
                                    id="product-featured123" value="1"
                                    {{ isset($product) && $product->product_refund == 1 ? 'checked' : '' }}
                                    data-modal-id="toggle-status-modal" data-toggle-id="product-featured123"
                                    data-on-image="product-status-on.png"
                                    data-off-image="product-status-off.png"data-on-title="Enable Refund for {{ $product->name ?? 'this product' }}"
                                    data-off-title="Disable Refund for {{ $product->name ?? 'this product' }}"
                                    data-on-message="<p>If enabled, customers will be allowed to request a refund for this product.</p>"
                                    data-off-message="<p>If disabled, customers will not be able to request a refund for this product.</p>">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        {{-- Add the new Column in Start --}}
                        {{-- <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0">{{ translate('product charge') }}
                                        ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
    
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('set_the_selling_price_for_each_unit_of_this_product._This_product_price_section_won’t_be_applied_if_you_set_a_variation_wise_price') }}.">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </div>
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('product_price') }}" name="product_price"
                                    value="{{ usdToDefaultCurrency($product->product_price) }}"" class="form-control"
                        ...
                        {{-- <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0">{{ translate('packaging charges') }}
                                        ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>

                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('set_the_selling_price_for_each_unit_of_this_product._This_package_price_section_won’t_be_applied_if_you_set_a_variation_wise_price') }}.">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </div>
                                <input type="number" min="0" step="0.01"
                                    ...
                                    value={{ usdToDefaultCurrency($product->package_price) }} class="form-control"
                                    required id="package-price">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0">{{ translate('COD charges') }}
                                        ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>

                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('set_the_selling_price_for_each_unit_of_this_product._This_cod_price_section_won’t_be_applied_if_you_set_a_variation_wise_price') }}.">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </div>
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('cod_price') }}" name="cod_price"
                                    value={{ usdToDefaultCurrency($product->cod_price) }} class="form-control" required
                                    id="cod-price">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0">{{ translate('Forward Shipping charges') }}
                                        ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>

                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('set_the_selling_price_for_each_unit_of_this_product._This_forward_price_section_won’t_be_applied_if_you_set_a_variation_wise_price') }}.">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </div>
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('forward_price') }}" name="forward_price"
                                    value={{ usdToDefaultCurrency($product->forward_price) }} class="form-control"
                                    id="forward-price" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0">{{ translate('Reverse Shipping charges') }}
                                        ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>

                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('set_the_selling_price_for_each_unit_of_this_product._This_reverse_price_section_won’t_be_applied_if_you_set_a_variation_wise_price') }}.">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </div>
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('reverse_price') }}" name="reverse_price"
                                    id="reverse-price" value={{ usdToDefaultCurrency($product->reverse_price) }}
                                    class="form-control" required>
                            </div>
                        </div> --}}
                        {{-- Add the new Column in End --}}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('unit_price') }}" name="unit_price" id="unit-price"
                                    class="form-control" value={{ usdToDefaultCurrency($product['unit_price']) }}
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3" id="minimum_order_qty">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" value={{ $product['minimum_order_qty'] }}
                                    step="1" placeholder="{{ translate('minimum_order_quantity') }}"
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            setTimeout(function() {
                ...
                getRequestFunctionality('{{ route('vendor.products.get-categories') }}?parent_id=' +
    ...
    <script>
        $(document).ready(function() {
            $('#tax').on('input', function() {
                ...
                if (value === 0) {
                    $('#tax_model').val('include').trigger('change').prop('readonly', true);
                } else {
                    $('#tax_model').val('exclude').trigger('change').prop('readonly', true);
                }
            });
        });
    </script>
    <script>
        ...
        function parsePrice(value) {
            return isEmpty(value) ? 0 : parseInt(value) || 0;
        }

        function calculateTotal() {
            var productprice = parsePrice($('#product-price').val());
            var packageprice = parsePrice($('#package-price').val());
            var codprice = parsePrice($('#cod-price').val());
            var forwardprice = parsePrice($('#forward-price').val());
            var reverseprice = parsePrice($('#reverse-price').val());

            var total = productprice + packageprice + codprice + forwardprice + reverseprice;
            $('#unit-price').val(total.toFixed(2)); // formats to 2 decimal places
        }

        $('#product-price, #package-price, #cod-price, #forward-price, #reverse-price').on('keyup change', function() {
            calculateTotal();
        });
    </script>
@endpush
