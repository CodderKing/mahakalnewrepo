                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <select name="filter" id="filter" class="form-control select2-selection__arrow">
                                        ...
                                        <option value="default_type" {{ $filter == 'default_type' ? 'selected' : '' }}>
                                            {{ translate('website_Order') }}</option>
                            ...
                            <tr>
                                ...
                                @if ($status == 'all')
                                    ...
                                    @else
                                        ...
                                        <th class="text-capitalize">{{ translate('cancel_by') }} </th>
                                    @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="title-color hover-c1"
                                            href="{{ route('vendor.orders.details', $order['id']) }}">{{ $order['id'] }}
