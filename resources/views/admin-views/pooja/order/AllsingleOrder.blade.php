...
@section('title', translate('All_single_Order_List'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ translate('All_single_Order_List') }}
                        ...
                        <div class="row align-items-center py-2">
                            ...
                            <div class="col-lg-10 col-sm-10">
                                <div class="d-flex align-items-center gap-3 p-3 bg-white shadow-sm rounded">
                                    <!-- Service Image -->
                                    <img src="{{ getValidImage(path: 'storage/app/public/pooja/thumbnail/' . $service['thumbnail'], type: 'backend-product') }}"
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="fw-bold text-dark">{{ $service->pooja_venue ?? 'no pooja_venue' }}</span>
                                        <span class="text-muted">{{ $orders->first()->booking_date ?? 'No Booking Date' }}</span>
                ...
                <div class="row mt-20">
                    <div class="col-md-12">
                        <div class="row align-items-center py-2">
                            ...
                            <div class="col-lg-10 col-sm-10">
                                <div class="d-flex align-items-center gap-3 p-3 bg-white shadow-sm rounded">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold text-dark">{{ $service->name }}</span>
                                        <span
                                            class="fw-bold text-dark">{{ $service->pooja_venue ?? 'no pooja_venue' }}</span>
                                        <span
                            ...
                            <a href="{{ route('admin.pooja.orders.memberspdf', [
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-around sweep-style">
                        <ul class="social-icons">
                            <li>
                                <a href="{{ route('admin.pooja.orders.generate.invoice', $order['id']) }}"
                            ...
                            <li>
                                {{-- <img src="{{ asset('public/assets/back-end/img/certificate/pooja/'.$serviceorder['pooja_certificate']) }}" alt="" width="20"> --}}
