...
@section('title', translate('Vip_pooja_Lead_List'))
@push('css_or_js')
            ...
            <table
              ...
              <thead class="thead-light thead-50 text-capitalize">
                <tr>
                  ...
                  Helpers::modules_permission_check('Vip order', 'Lead', 'follow-up') ||
                  Helpers::modules_permission_check('Vip order', 'Lead', 'follow-up-history') ||
                  Helpers::modules_permission_check('Vip order', 'Lead', 'call'))
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-center gap-2">
                      ...
                      @if (Helpers::modules_permission_check('Vip Order', 'Lead', 'delete'))
                      <a href="{{ route('admin.vippooja.order.lead-delete', ['id' => $lead['id']]) }}"
                      ...
                      <a href="javascript:void(0)"
                        class="btn btn-icon bg-label-success waves-effect  myactionbtn"
                    ...
                    <div class="d-flex justify-content-center gap-2 pt-2">
                      ...
                      <a href="javascript:0"
                        class="btn btn-icon bg-label-info waves-effect  myactionbtn"
                      ...
                      <a href="tel:{{ $lead['person_phone'] }}"
                        class="btn btn-icon bg-label-warning waves-effect  myactionbtn"
                    ...
                    <div class="d-flex justify-content-center gap-2 pt-2">
                      <a href="{{ route('admin.vippooja.order.orders.send-whatsapp-leads', ['id' => $lead['id']]) }}"
...
<div class="modal fade" id="followUpModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.vippooja.order.lead-follow-up') }}" method="POST">
        @csrf
        @php
        if (auth('admin')->check()) {
...
<script>
  function followHistory(that) {
      ...
      var row = "";
      $.ajax({
          url: "{{ url('admin/vippooja/order/get-follow-list') }}/" + leadId,
          method: 'GET',
          data: {
              id: leadId
          },
