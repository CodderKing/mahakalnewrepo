...
<body>
    ...
    <!-- Content Section -->
    <div class="content">
        <h2 style="text-align: center;">{{ $chadhava ?? 'Chadhava Name Not Available' }}</h2>
        <h4 style="text-align: center;">{{ $chadhava_venue ?? 'chadhava Venue Not Available' }}</h4>
        <h4 style="text-align: left;">Chadhava Proforming Date - {{ $bookingDate }}</h4>
