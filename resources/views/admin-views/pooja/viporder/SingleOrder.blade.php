...
@section('title', translate('VIP|ORDER LIST'))
@push('css_or_js')
                ...
                <div class="row mt-20">
                    <div class="col-md-12">
                        ...
                        <div class="row align-items-center py-2">
                            ...
                            <a href="{{ route('admin.vippooja.order.memberspdf', [
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-around sweep-style">
                        <ul class="social-icons">
                            <li>
                                <a href="{{ route('admin.vippooja.order.generate.invoice', $order['id']) }}"
