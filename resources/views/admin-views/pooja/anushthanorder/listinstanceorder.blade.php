...
@section('title', translate('Anushthan_Pooja_Instance_Order_List'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2 align-items-center">
                ...
                {{ translate('Anushthan_Pooja_Instance_Order_List') }}
                ...
                <div class="row g-2" id="order_stats">
                    <div class="col-lg-3">
                        <div class="card card-body h-100 justify-content-center">
                            @php
                                $totalPaymentAmount = \App\Models\Service_order::where('type', 'anushthan')->where('package_id',8)->sum(
                                    'pay_amount',
                                );
                            @endphp
                    ...
                    <div class="col-md-3">
                        <div class="card card-body h-100 justify-content-center">
                            <div class="d-flex gap-2 justify-content-between align-items-center">
                                <div class="d-flex flex-column align-items-start">
                                    <h3 class="mb-1 fz-24 text-info">
                                        {{ \App\Models\Service_order::where('type', 'anushthan')->where('package_id', 8)->count() }}
                                    </h3>
                            ...
                            <div class="d-flex gap-2 justify-content-between align-items-center">
                                <div class="d-flex flex-column align-items-start">
                                    <h3 class="mb-1 fz-24 text-primary">
                                        {{ \App\Models\Service_order::where('type', 'anushthan')->where('package_id', 8)->where('status', 0)->where('order_status', 0)->where('is_completed', 0)->count() }}
                                    </h3>
                            ...
                            <div class="d-flex gap-2 justify-content-between align-items-center">
                                <div class="d-flex flex-column align-items-start">
                                    <h3 class="mb-1 fz-24 text-success">
                                        {{ \App\Models\Service_order::where('type', 'anushthan')->where('package_id', 8)->where('is_completed', 1)->where('status', 1)->where('order_status',1)->count() }}
                                    </h3>
                        ...
                        <div class="col-md-3">
                            <div class="card card-body h-100 justify-content-center">
                                <div class="d-flex gap-2 justify-content-between align-items-center">
                                    <div class="d-flex flex-column align-items-start">
                                        <h3 class="mb-1 fz-24 text-info">
                                            {{ \App\Models\Service_order::where('type', 'anushthan')->where('order_status', 3)->where('package_id', 8)->count() }}
                                        </h3>
                                ...
                                <div class="d-flex gap-2 justify-content-between align-items-center">
                                    <div class="d-flex flex-column align-items-start">
                                        <h3 class="mb-1 fz-24 text-danger">
                                            {{ \App\Models\Service_order::where('type', 'anushthan')->where('order_status', 4)->where('package_id', 8)->where('is_completed', 1)->where('status', 1)->count() }}
                                        </h3>
                        ...
                        <div class="col-md-3">
                            <div class="card card-body h-100 justify-content-center">
                                <div class="d-flex gap-2 justify-content-between align-items-center">
                                    <div class="d-flex flex-column align-items-start">
                                        <h3 class="mb-1 fz-24 text-primary">
                                            {{ \App\Models\Service_order::where('type', 'anushthan')->where('order_status', 5)->where('package_id', 8)->where('status', 0)->where('is_completed', 0)->count() }}
                                        </h3>
                            ...
                            <table id="myTable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        @if (Helpers::modules_permission_check('Anushthan Order', 'All', 'detail') ||
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b>
                                                    ...
                                                    @else
                                                        <span class="text-muted">No Anushthan details available</span>
                                                    @endif
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        @if ($order->order_status == 6 && $order->status == 6)
                                                            @if (Helpers::modules_permission_check('Anushthan Order', 'All', 'schedule') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Pending', 'schedule') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Completed', 'schedule') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'schedule') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'schedule'))
                                                        ...
                                                        @else
                                                            ...
                                                            @if (Helpers::modules_permission_check('Anushthan Order', 'All', 'download') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Pending', 'download') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Completed', 'download') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'download') ||
                                                                    Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'download'))
                                                                <a class="btn btn-outline-info btn-sm square-btn"
                                                                    target="_blank"
                                                                    href="{{ route('admin.anushthan.order.generate.invoice', $order['id']) }}">
                ...
                <div class="modal-header">
                    <div>
                        ...
                        <p class="text-muted small mt-1">
                            You are about to change the assigned Pandit (Purohit) for this Anushthan order. Please ensure
            ...
            $('.order-link').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        <tr><th><b>Pooja Details</b></th><td colspan=3><b>Pooja Name:</b>${data.anushthans.name},<br><b>Pooja Venue:</b></td><th><b>Prashad(YES/NO)</b></th><td><span class="badge badge-soft-${data.prashad_status == 0 ? 'primary' : (data.prashad_status == 1 ? 'success' : 'danger')}">
