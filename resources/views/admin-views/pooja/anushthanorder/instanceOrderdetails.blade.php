...
@section('title', translate('instance_anushthan_|_order_details'))
        ...
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img width="20px" src="{{ dynamicAsset(path: 'public/assets/back-end/img/pooja/vippooja.png') }}"
                    alt="">
                {{ translate('instance_anushthan_|_order_details') }}
            </h2>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap flex-md-nowrap gap-10 justify-content-between mb-4">
                            <div class="d-flex flex-column gap-10">
                                <h4 class="text-capitalize">{{ translate('Anushthan_Instance_details') }} </h4>
                    ...
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @if (empty($details['pandit_assign']))
                            <div class="">
                                ...
                                <form
                                    action="{{ route('admin.vippooja.order.assign.allpandit', ['service_id' => $service, 'status' => 0]) }}"
                    ...
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        <div class="d-flex align-items-center justify-content-between gap-2">
                            <h4 class="mb-0 text-center"><i class="tio-shopping-cart-outlined nav-icon"></i>
                                {{ translate('instance_puja_order_status') }}</h4>
                        </div>
                        @if ($details['status'] == 0)
                            <div class="">
                                ...
                                <form action="{{ route('admin.anushthan.order.allinstancestatus') }}" method="post" id="order-status-form">
                                    @csrf
                    ...
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        <div class="d-flex align-items-center justify-content-between gap-2">
                            <h4 class="mb-0 text-center">
                                <i class="tio-sidelight-information nav-icon"></i>
                    ...
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        <div class="d-flex align-items-center justify-content-between gap-2">
                            <h4 class="mb-0 text-center"><i class="tio-route nav-icon"></i>
                                {{ translate('Anushthan_Order_tracking') }}</h4>
                        </div>
                        <div class="">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  action="{{ route('admin.anushthan.order.assign.allpandit') }}" class="modal-form"
    ...
    <div class="modal fade" id="order-cancel-modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form
                    action="{{ route('admin.anushthan.order.cancel_instance') }}" class="modal-form" 
    ...
    <div class="modal fade" id="order-time-modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title">Anushthan  Pooja Time Schedule</h5>
                ...
                <form
                    action="{{ route('admin.anushthan.order.time_instance') }}" class="modal-form"
                    method="post" id="pooja-time-form">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="package_id" id="package_id" value="{{  $details->package_id }}">
                        <input type="hidden" name="booking_date" id="booking_id" value="{{$details->booking_date}}">
    ...
    <div class="modal fade" id="order-live-modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form
                    action="{{ route('admin.anushthan.order.stream_instance') }}" class="modal-form"
                    method="post" id="pooja-live-form">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="package_id" id="package_id" value="{{  $details->package_id }}">
                        <input type="hidden" name="booking_date" id="booking_id" value="{{$details->booking_date}}">
    ...
    <div class="modal fade" id="order-video-modal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form
                    action="{{ route('admin.anushthan.order.video_instance') }}" class="modal-form"
                    method="post" id="pooja-video-form">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="package_id" id="package_id" value="{{  $details->package_id }}">
                        <input type="hidden" name="booking_date" id="booking_id" value="{{$details->booking_date}}">
