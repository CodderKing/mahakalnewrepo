...
@section('title', translate('Anushthan_Order|List'))
@push('css_or_js')
...
@section('content')
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                <img width="20" src="{{ dynamicAsset(path: 'public/assets/back-end/img/pooja/anushthan.png') }}"
                    alt="">
                {{ translate('Anushthan_Order|List') }}
      ...
      <div class="card-body">
         @php
         $totalPaymentSuccess = \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)
         ->where('status', 0)
         ->where('payment_status', 1)
         ->sum('pay_amount');
         $totalPaymentPending = \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)
         ->where('status', 0)
         ->where('payment_status', 0)
         ->sum('pay_amount');
         $totalPaymentFaild = \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)
         ->where('status', 0)
         ...
         <div class="row g-3" id="order_stats">
            <div class="col-lg-12">
               ...
               <div class="col-md-4">
                     <div class="card card-body h-100 justify-content-center">
                        <div class="d-flex gap-2 justify-content-between align-items-center">
                           <div class="d-flex flex-column align-items-start">
                              ...
                              <div class="text-capitalize mb-0 text-success">Anushthan Success Earning</div>
                           </div>
                           <div>
                  ...
                  <div class="col-md-4">
                     <a href="{{ route('admin.anushthan.order.list', 'all') }}" class="text-decoration-none">
                        <div class="card card-body h-100 justify-content-center">
                           <div class="d-flex gap-2 justify-content-between align-items-center">
                              <div class="d-flex flex-column align-items-start">
                                 ...
                                 <div class="text-capitalize mb-0 text-warning">Anushthan Pending Earning</div>
                              </div>
                              <div>
                                 <img width="40" class="mb-2 rotate-icon"
                                    src="{{ dynamicAsset(path: 'public/assets/back-end/img/pooja/rupay.png') }}"
                        ...
                        <div class="card card-body h-100 justify-content-center">
                           <div class="d-flex gap-2 justify-content-between align-items-center">
                              <div class="d-flex flex-column align-items-start">
                                 ...
                                 <div class="text-capitalize mb-0 text-danger">Anushthan Faild Earning</div>
                              </div>
                              <div>
                                 <img width="40" class="mb-2 rotate-icon"
                                    src="{{ dynamicAsset(path: 'public/assets/back-end/img/pooja/rupay.png') }}"
                           ...
                           <div class="d-flex gap-2 justify-content-between align-items-center">
                              <div class="d-flex flex-column align-items-start">
                                 <h3 class="mb-1 fz-24 text-info">
                                    {{ \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)->count() }}
                                 </h3>
                  ...
                  <div class="col-md-3">
                     <a href="{{ route('admin.anushthan.order.list', 1) }}" class="text-decoration-none">
                        <div class="card card-body h-100 justify-content-center">
                           <div class="d-flex gap-2 justify-content-between align-items-center">
                              <div class="d-flex flex-column align-items-start">
                                 <h3 class="mb-1 fz-24 text-success">
                                    {{ \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)->where('is_completed', 1)->where('status', 1)->where('payment_status', 1)->count() }}
                                 </h3>
                  ...
                  <div class="col-md-3">
                     <a href="{{ route('admin.anushthan.order.list', 0) }}" class="text-decoration-none">
                        <div class="card card-body h-100 justify-content-center">
                           <div class="d-flex gap-2 justify-content-between align-items-center">
                              <div class="d-flex flex-column align-items-start">
                                 <h3 class="mb-1 fz-24 text-primary">
                                    {{ \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)->where('status', 0)->where('is_completed', 0)->where('payment_status', 1)->count() }}
                                 </h3>
                  ...
                  <div class="col-md-3">
                     <a href="{{ route('admin.anushthan.order.list', 6) }}" class="text-decoration-none">
                        <div class="card card-body h-100 justify-content-center">
                           <div class="d-flex gap-2 justify-content-between align-items-center">
                              <div class="d-flex flex-column align-items-start">
                                 <h3 class="mb-1 fz-24 text-danger">
                                    {{ \App\Models\Service_order::where('type', 'anushthan')->where('is_block', '!=', 9)->where('status', 6)->where('order_status', 6)->count() }}
                                 </h3>
      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="px-3 py-4">
               <div class="row g-2 flex-grow-1">
                  <div class="col-md-12">
                     <table id="anushthanOrderTable" class="table table-bordered">
                        <thead>
                           <tr>
                            <th>{{ translate('SL') }}</th>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-8">
                            <form action="{{ route('admin.anushthan.order.updatedOrder') }}" method="post"
                                id="Rejcted_model">
                                @csrf
...
@push('script')
   ...
   $(document).ready(function () {
       $('#anushthanOrderTable').DataTable({
           ...
           ajax: "{{ route('admin.anushthan.order.data') }}",
           order: [[0, 'asc']],
           columns: [
               {
                   data: 'payment_status',
               ...
               },
               {
                ...
                render: (data, type, row) => {
                    ...
                    @if (
                        Helpers::modules_permission_check('Anushthan Order', 'All', 'schedule') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Pending', 'schedule') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Completed', 'schedule') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'schedule') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'schedule')
                    )
                    ...
                    @if (
                        Helpers::modules_permission_check('Anushthan Order', 'All', 'detail') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Pending', 'detail') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Completed', 'detail') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'detail') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'detail')
                    )
                    ...
                    @if (
                        Helpers::modules_permission_check('Anushthan Order', 'All', 'download') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Pending', 'download') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Completed', 'download') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Canceled', 'download') ||
                        Helpers::modules_permission_check('Anushthan Order', 'Rejected', 'download')
                    )
                        buttons += `
    ...
    <script>
        const baseDetailUrl = "{{ url('admin/anushthan/order/details') }}";
        const baseInvoiceUrl = "{{ url('admin/anushthan/order/generate/invoice') }}";
    </script>
    <script>
        // datepicker
        var today = new Date();
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.order-link').click(function(e) {
                ...
                $.ajax({
                    url: "{{ url('admin/anushthan/order/get-order-details') }}",
                    type: 'GET',
                    data: {
                        id: orderId
                    },
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#customer_id').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.anushthan.order.get-customer-orders') }}",
                    type: "GET",
                    data: {
            ...
            $('#blockOrdersBtn').click(function() {
                ...
                $.ajax({
                    url: "{{ route('admin.anushthan.order.block-orders') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
