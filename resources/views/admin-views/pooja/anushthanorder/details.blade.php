            ...
            <div class="col-lg-4 d-flex flex-column gap-3">
                ...
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @else
                        <div class="text-center position-relative d-inline-block anushthan-container">
                            <!-- Trigger Image -->
                            <img src="{{ asset('public/' . $details['pooja_certificate']) }}"
                                 alt="VIP Certificate Image"
                                 width="300px"
                                 class="img-fluid anushthan-image"
                                 data-toggle="modal"
                                 data-target="#anushthanModal"
                                 style="cursor: pointer;">
                        </div>
                        
                        <!-- Modal -->
                        <div class="modal fade" id="anushthanModal" tabindex="-1" role="dialog" aria-labelledby="anushthanModalLabel" aria-hidden="true">
