...
<div class="content container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-md-12 mb-3">
         <div class="card">
            <div class="card-body">
               <form action="{{ route('admin.event-managment.category.edit',[$old_data['id']]) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <!-- Language tabs -->
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        ...
                        <?php
                                            if (count($old_data['translations'])) {
                                                ...
                                                foreach ($old_data['translations'] as $translations) {
                                                    if ($translations->locale == $lang && $translations->key == 'category_name') {
                                                        $translate[$lang]['category_name'] = $translations->value;
                                                    }
                                                }
                                            }
                                            ?>
                        <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form"
                           ...
                           <input type="text" name="category_name[]" class="form-control" id="name"  value="{{ $lang == $defaultLanguage ? $old_data['category_name'] : $translate[$lang]['category_name'] ?? '' }}"
                     ...
                     <div class="col-md-4 mb-4">
                        <div class="text-center">
                           <img class="upload-img-view" id="detail-viewer"
                              src="{{ getValidImage(path: 'storage/app/public/event/category/'.$old_data['image'], type: 'backend-product')  }}"
                              alt="">
                        </div>
