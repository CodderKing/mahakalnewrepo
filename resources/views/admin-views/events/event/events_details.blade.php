      ...
      <div class="card w-100">
         <div class="card-body">
            <ul class="nav nav-tabs w-fit-content mb-4">
               ...
               <li class="nav-item text-capitalize">
                  <a class="nav-link" id="transation-withdrowal-tab" data-toggle="tab" href="#transation-withdrowal-content">
                     {{ translate('withdrowal_transation') }}
                  </a>
               </li>
               @endif
               @if($view_type == 2)
            ...
            <div class="tab-content">
               <div class="tab-pane fade {{ (($name == 'null')?'show active':'') }}" id="overview-content">
                  <div class="row">
                     @include('admin-views.events.event.events_details.overview')
                  </div>
               </div>
               @if($view_type == 1)
               ...
               <div class="tab-pane fade" id="event-information">
                  <div class="row">
                     @include('admin-views.events.event.events_details.event_infomation')
                  </div>
               </div>
               @endif
               @if($view_type == 2)
               ...
               <div class="tab-pane fade" id="setting-content">
                  <div class="row">
                     @include('admin-views.events.event.events_details.setting')
                  </div>
               </div>
               @endif
               @if($view_type == 1)
               ...
               <div class="tab-pane fade" id="transation-withdrowal-content">
                  <div class="row">
                     @include('admin-views.events.event.events_details.eventwithdrowaltransaction')
                  </div>
               </div>
               @endif
               @if($view_type == 2)
