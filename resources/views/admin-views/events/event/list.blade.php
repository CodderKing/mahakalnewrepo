        ...
        <div class="col-md-12 mb-2">
            <div class='row'>
                <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('admin.event-managment.event.list')}}">
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::count();
                            @endphp
                        </span>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 col-md-3  mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('admin.event-managment.event.list',['organizer'=>'inhouse'])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::where('organizer_by','inhouse')->count();
                            @endphp
                        </span>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
                    <a class="order-stats order-stats_confirmed" href="{{ route('admin.event-managment.event.list',['organizer'=>'outside'])}}">
                        <div class="order-stats__content">
                            <i class="tio-all_done">all_done</i>
                        ...
                        <span class="order-stats__title">
                            @php
                            echo \App\Models\Events::where('organizer_by','outside')->count();
                            @endphp
                        </span>
                    </a>
                </div>
