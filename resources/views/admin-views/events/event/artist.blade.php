...
<div class="content container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-md-12 mb-3">
         <div class="card">
            <div class="card-body">
               <form action="{{ route('admin.event-managment.event.artist_store') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <!-- Language tabs -->
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <form action="{{route('admin.event-managment.event.artist_status-update') }}" method="post" id="items-status{{$items['id']}}-form">
                                 @csrf
                                 ...
                                 <label class="switcher mx-auto">
                                    <input type="checkbox" class="switcher_input toggle-switch-message" name="status"
                                       ...
                                       data-on-message="<p>{{ translate('if_enabled_this_event_artist_will_be_available_on_the_website_and_customer_app') }}</p>"
                                       data-off-message="<p>{{ translate('if_disabled_this_event_artist_will_be_hidden_from_the_website_and_customer_app') }}</p>">
                           ...
                           <td>
                              <div class="d-flex justify-content-center gap-2">
                                 <a class="btn btn-outline-info btn-sm square-btn" title="{{ translate('edit') }}" href="{{route('admin.event-managment.event.artist_update',[$items['id']])}}">
                                    <i class="tio-edit"></i>
                                 </a>
