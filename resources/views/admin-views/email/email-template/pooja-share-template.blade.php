                ...
                @if ($bookingDetails && isset($bookingDetails->type))
                    @if ($bookingDetails->type == 'pooja')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapki {{ $service_name['name'] }} puja ka video ab uplabdh hai! 😊
                        </p>
                    ...
                    @elseif ($bookingDetails->type == 'anushthan')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapke {{ $service_name['name'] }} anushthan ka video ab uplabdh hai! 🙌
                        </p>
                    @elseif ($bookingDetails->type == 'chadhava')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapke {{ $service_name['name'] }} chadhava ka video ab uplabdh hai! 😊
                        </p>
                    @else
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapki puja ka video ab uplabdh hai! 😊
                        </p>
                    @endif
                @else
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">Aapki puja ka video ab uplabdh hai!</p>
                @endif
            </td>
        </tr>
        <!-- Content Section -->
        @if ($bookingDetails)
                ...
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🔗Puja Video Link:</strong> {{ $bookingDetails['pooja_video'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
            ...
            @elseif($bookingDetails->type == 'anushthan')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🔗Anushthan Video Link:</strong> {{ $bookingDetails['pooja_video'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
            ...
            @elseif($bookingDetails->type == 'chadhava')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🔗Chadhava Video Link:</strong> {{ $bookingDetails['pooja_video'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
