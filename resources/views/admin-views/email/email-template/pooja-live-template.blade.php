                ...
                @if ($bookingDetails && isset($bookingDetails->type))
                    @if ($bookingDetails->type == 'pooja')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapki {{ $service_name['name'] }} puja ab live ho gayi hai! 😊
                        </p>
                    ...
                    @else
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapki puja ab live ho gayi hai! 😊
                        </p>
                    @endif
                @else
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">Aapki puja ab live ho gayi hai!</p>
                @endif
            </td>
        </tr>
        <!-- Content Section -->
        @if ($bookingDetails)
                ...
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📺 Live Puja Link:</strong> {{ $bookingDetails['live_stream'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
            ...
            @elseif($bookingDetails->type == 'anushthan')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📺 Live Anushthan Link:</strong> {{ $bookingDetails['live_stream'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
            ...
            @elseif($bookingDetails->type == 'chadhava')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📺 Live Chadhava Link:</strong> {{ $bookingDetails['live_stream'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
