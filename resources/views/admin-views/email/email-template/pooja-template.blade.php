            ...
            <td style="padding: 10px; text-align: center; background-color: #f0f0f0;">
                ...
                @if ($bookingDetails->type == 'pooja')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Aapki Puja booking safaltapurvak prapt ho gayi hai. 😊
                    </p>
                @elseif ($bookingDetails->type == 'vip')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Aapki VIP Puja booking safaltapurvak prapt ho gayi hai. 🌟
                    </p>
                @elseif ($bookingDetails->type == 'anushthan')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Aapki Anushthan booking safaltapurvak prapt ho gayi hai. 🙌
                    </p>
                @elseif ($bookingDetails->type == 'chadhava')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Aapki Chadhava booking safaltapurvak prapt ho gayi hai. 😊
                    </p>
                @elseif ($bookingDetails->type == 'counselling')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Aapki Counselling session booking safaltapurvak prapt ho gayi hai. 🗣️
                    </p>
                @else
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Aapki booking safaltapurvak prapt ho gayi hai. 😊
                    </p>
                @endif
            </td>
        </tr>
            ...
            @if ($bookingDetails->type == 'pooja')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        ...
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>💰 Puja Rashi:</strong>
                            {{ webCurrencyConverter($bookingDetails['pay_amount'] - $bookingDetails['coupon_amount']) }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                        ...
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🏛️ Venue:</strong> {{ $service_name['pooja_venue'] }}
                        </p>
                    </td>
                </tr>
            @elseif($bookingDetails->type == 'vip')
            ...
            @elseif($bookingDetails->type == 'chadhava')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        ...
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🏛️ Venue:</strong> {{ $service_name['chadhava_venue'] }}
                        </p>
                    </td>
                </tr>
            @elseif($bookingDetails->type == 'counselling')
