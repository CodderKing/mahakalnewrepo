            ...
            <td style="padding: 10px; text-align: center; background-color: #f0f0f0;">
                ...
                @if ($bookingDetails->type == 'pooja')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Puja ke liye aapke dwara bheji gyi jankari. 😊
                    </p>
                ...
                @elseif ($bookingDetails->type == 'anushthan')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Anushthan ke liye aapke dwara bheji gyi jankari. 🙌
                    </p>
                @elseif ($bookingDetails->type == 'chadhava')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Chadhava ke liye aapke dwara bheji gyi jankari. 😊
                    </p>
                @elseif ($bookingDetails->type == 'counselling')
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Consultation ke liye aapke dwara bheji gyi jankari. 🗣️
                    </p>
                @else
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">
                        Puja ke liye aapke dwara bheji gyi jankari. 😊
            ...
            @if ($bookingDetails->type == 'pooja')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <h2 style="font-size: 20px; color: #333;">Member Details:</h2>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📛 Member Name:</strong> {{ $formattedMembers }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📜 Gotra:</strong> {{ $request->input('gotra') }}
                        </p>
                    </td>
                </tr>
            @elseif($bookingDetails->type == 'vip')
            ...
            @elseif($bookingDetails->type == 'chadhava')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <h2 style="font-size: 20px; color: #333;">Member Details:</h2>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📛 Member Name:</strong> {{ $UsersData['members'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📜 Gotra:</strong> {{ $request->input('gotra') }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🙏 Chadhava Reason:</strong> {{ $request->input('reason') }}
                        </p>
                    </td>
                </tr>
            @elseif($bookingDetails->type == 'counselling')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        ...
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📛 Name:</strong> {{ $dob['name'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📛 Gender:</strong> {{ $dob['gender'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🏙️ City:</strong> {{ $dob['city'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🌍 Country:</strong> {{ $dob['country'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>⏰ Time:</strong> {{ date('h:i A', strtotime($dob['time'])) }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
