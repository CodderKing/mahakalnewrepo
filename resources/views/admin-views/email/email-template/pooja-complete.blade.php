                ...
                @if ($bookingDetails && isset($bookingDetails->type))
                    @if ($bookingDetails->type == 'pooja')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapki {{ $service_name['name'] }} puja safaltapurvak sampann ho gayi hai! 😊
                        </p>
                    ...
                    @elseif ($bookingDetails->type == 'anushthan')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapka {{ $service_name['name'] }} Anushthan safaltapurvak sampann ho gaya hai! 🙌
                        </p>
                    @elseif ($bookingDetails->type == 'chadhava')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapka {{ $service_name['name'] }} Chadhava safaltapurvak sampann ho gaya hai! 😊
                        </p>
                    @elseif ($bookingDetails->type == 'counselling')
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapka {{ $service_name['name'] }} Consultation safaltapurvak sampann ho gaya hai! 😊
                        </p>
                    @else
                        <p style="font-size: 16px; color: #555; margin: 5px 0;">
                            Aapki puja safaltapurvak sampann ho gaya hai! 😊
                        </p>
                    @endif
                @else
                    <p style="font-size: 16px; color: #555; margin: 5px 0;">Aapki puja safaltapurvak sampann ho gaya
                        hai!</p>
                @endif
            </td>
        </tr>
                ...
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📜 Certificate Download:</strong> <a
                                href="{{ asset('public/' . $bookingDetails['pooja_certificate']) }}">Download
                                Certificate</a>
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
            ...
            @elseif($bookingDetails->type == 'counselling')
                <tr>
                    <td style="padding:5px; background-color: #f9f9f9;">
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>📜 Certificate Download:</strong> <a
                                href="{{ asset('storage/app/public/consultation-order-report/' . $bookingDetails['counselling_report']) }}">Download
                                Report</a>
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🆔 Consultation Name:</strong> {{ $service_name['name'] }}
                        </p>
                        <p style="font-size: 16px; color: #555; margin:5px;">
                            <strong>🆔 Order ID:</strong> {{ $bookingDetails['order_id'] }}
                        </p>
