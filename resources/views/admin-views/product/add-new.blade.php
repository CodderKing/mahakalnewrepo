                    ...
                    @foreach ($languages as $lang)
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group pt-2">
                                ...
                                <textarea class="" id="editor{{ $lang }}" name="description[]">{{ old('details') }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select name="product_type" id="product_type" class="form-control" required>
                                    ...
                                    <option value="pooja" selected>{{ translate('pooja') }}</option>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="digital_file_ready_show">
                            <div class="form-group">
                                ...
                                <div class="mt-2">{{ translate('file_type') }}: {{ 'jpg, jpeg, png, gif, zip, pdf' }}
                                </div>
                            </div>
                        </div>
            ...
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-3 align-items-center">
                        ...
                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                            title="{{ translate('Rs. 50 will be deducted on Cash on Delivery orders') }}.">
                            <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                alt="">
                        </span>
                        <div class="form-group m-0">
                            <label class="switcher mb-0 d-flex align-items-center">
                                <input type="checkbox" class="switcher_input toggle-switch-message" name="product_refund"
                                    id="product-featured123" value="1" data-modal-id="toggle-status-modal"
                                    data-toggle-id="product-featured123" data-on-image="product-status-on.png"
                                    data-off-image="product-status-off.png"
                                    data-on-title="Enable Refund for {{ $product->name ?? 'this product' }}"
                        ...
                        {{-- <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('product_price') }}" name="product_price" value="0"
                                    class="form-control" required id="product-price">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('package_price') }}" name="package_price" value="0"
                                    class="form-control" required id="package-price">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('cod_price') }}" name="cod_price" value="0"
                                    class="form-control" required id="cod-price">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('forward_price') }}" name="forward_price" value="0"
                                    class="form-control" id="forward-price" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    ...
                                    id="reverse-price" value="0" class="form-control" required>
                            </div>
                        </div> --}}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    ...
                                    value="{{ old('unit_price') }}" class="form-control" id="unit-price" required>
                            </div>
                        </div>
