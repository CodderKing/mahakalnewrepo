...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('admin.products.update', $product->id) }}" method="post"
                    ...
                    @foreach ($languages as $language)
                        ...
                        <div class="{{ $language != 'en' ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <textarea name="description[]" class="" id="editor{{ $language }}">{!! $translate[$language]['description'] ?? $product['details'] !!}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select name="product_type" id="product_type" class="form-control" required>
                                    ...
                                    <option value="pooja" {{ $product->product_type == 'pooja' ? 'selected' : '' }}>
                                        {{ translate('pooja') }}</option>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="generate_number" name="code" class="form-control"
                                    value="{{ $product->code }}" placeholder="{{ translate('ex') . ': 161183' }}"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="form-group m-0">
                                <label class="switcher mb-0 d-flex align-items-center">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="product_refund" id="product-featured123" value="1"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    ...
                                    id="unit-price" value={{ usdToDefaultCurrency($product->unit_price) }}
                                    required>
                            </div>
                        </div>
                        ...
                        let exist_image_html = `
                            ...
                            `&color=` + color_value['color'] + `"
                                    ...
                                    <img class="w-100" height="auto"
                                        ...
                                        src="{{ dynamicStorage(path: 'storage/app/public/product') }}/` +
                            image_name + `"
                                        alt="Product image">
                                </div>
                            </div>`;
