                        ...
                        <div class="card-body">
                            <form id="form-id" action="{{ route('login') }}" method="post" id="admin-login-form">
                                ...
                                <button type="button" class="btn btn-lg btn-block btn--primary"
                                    id="submit_form_button" style="display: none">
                                    {{ translate('login') }}
                                </button>

                                <button type="button" class="btn btn-lg btn-block btn--primary" id="submit_button">
                                    {{ translate('login') }}
                                </button>
                            </form>
                        </div>
...
<script type="text/javascript">
    $('#submit_button').on('click', function() {
        ...
        var password = $('#signingAdminPassword').val();
        let data = {
            _token: '{{ csrf_token() }}',
            email: email,
            password: password
