...
@section('title', translate('pandit/pooja_List'))
...
@section('content')
    <div class="content container-fluid">
        <div class="row g-2 flex-grow-1">
                ...
                <div class="mb-3">
                    <h2 class="h1 mb-0 d-flex gap-2">
                        <img width="20" src="{{ dynamicAsset(path: 'public/assets/back-end/img/rashi.png') }}"
                            alt="">
                        {{ translate('pandit/pooja_List') }} <span class="badge badge-soft-info badge-pill ml-1">
            ...
            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                ...
                <a href="{{ route('admin.service.offline.pooja.add-new') }}" class="btn btn--primary">
                    <i class="tio-add"></i>
                    <span class="text">{{ translate('add_new_pandit/pooja') }}</span>
                </a>
                {{-- @endif --}}
            </div>
        </div>
            ...
            <div class="row g-2">
                    ...
                    <div class="card card-body h-100 justify-content-center">
                        <div class="d-flex gap-2 justify-content-between align-items-center">
                            <div class="d-flex flex-column align-items-start">
                                <h3 class="mb-1 fz-24"> {{ \App\Models\PoojaOffline::count() }}
                                </h3>
                                <div class="text-capitalize mb-0">TOTAL Pandit/Pooja</div>
                            </div>
                            <div>
                                <img width="40"
                ...
                {{-- <div class="col-md-4">
                    <div class="card card-body h-100 justify-content-center">
                        <div class="d-flex gap-2 justify-content-between align-items-center">
                            <div class="d-flex flex-column align-items-start">
                                <h3 class="mb-1 fz-24">
                                    {{ \App\Models\PoojaOffline::where('status', 1)->where('type','pooja')->count() }}
                                </h3>
                                <div class="text-capitalize mb-0">ACTIVE NORMAL POOJA</div>
                            </div>
                            <div>
                                <img width="40"
                ...
                <div class="col-md-4">
                    <div class="card card-body h-100 justify-content-center">
                        <div class="d-flex gap-2 justify-content-between align-items-center">
                            <div class="d-flex flex-column align-items-start">
                                <h3 class="mb-1 fz-24">{{ \App\Models\PoojaOffline::where('status', 1)->where('type','instant-pooja')->count() }}
                                </h3>
                                <div class="text-capitalize mb-0">ACTIVE INSTANT POOJA</div>
                            </div>
                            <div>
                                <img width="40"
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table id="myTable"
                                ...
                                <tbody>
                                    @foreach ($offlinePooja as $key => $item)
                                        <tr>
                                            <td>{{ $offlinePooja->firstItem() + $key }}</td>
                                            <td><img src="{{ getValidImage(path: 'storage/app/public/offlinepooja/thumbnail/' . $item['thumbnail'], type: 'backend-product') }}"
                                                    class="avatar border" alt=""></td>
                                            <td>
                                            ...
                                            {{-- @if (Helpers::modules_permission_check('Pooja Managment', 'Pooja', 'status')) --}}
                                            <td>
                                                <form action="{{ route('admin.service.offline.pooja.status-update') }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <a class="btn btn-outline-info btn-sm square-btn"
                                                        ...
                                                        href="{{ route('admin.service.offline.pooja.update', [$item['id']]) }}">
                                                        <i class="tio-edit"></i>
                                                    </a>
                                                    {{-- @endif --}}
                                                    ...
                                                    {{-- @endif --}}
                                                    <form
                                                        action="{{ route('admin.service.offline.pooja.delete', [$item['id']]) }}"
    ...
    <span id="route-admin-rashi-status-update" data-url="{{ route('admin.service.offline.pooja.status-update') }}"></span>
    <!-- Modal Structure -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="serviceModalLabel">Offile Pooja Details</h5>
...
<script>
        $(document).on('click', '.open-whatsapp-modal', function () {
            ...
            const link = `https://mahakal.com/offline/pooja/detail/${slug}`;
