...
@section('title', translate('add_pandit/pooja'))
    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ translate('add_pandit/pooja') }}
            </h2>
        </div>

        <form class="product-form text-start" action="{{ route('admin.service.offline.pooja.add-new') }}" method="POST"
                    ...
                    @foreach ($languages as $lang)
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="terms-condition-{{ $lang }}-tab"
                                        data-toggle="pill" data-target="#terms-condition-{{ $lang }}"
                                        type="button" role="tab" aria-controls="terms-condition-{{ $lang }}"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="terms-condition-{{ $lang }}" role="tabpanel"
                                    aria-labelledby="terms-condition-{{ $lang }}-tab">

                                    <label class="title-color"
                                        for="{{ $lang }}_terms_conditions">{{ translate('terms_conditions') }}
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}" {{ $language == 'en' ? 'required' : 'required' }}
                                        name="terms_conditions[]">{{ old('terms_condition') }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <table class="table table-borderless table-hover">
                                    ...
                                    <tbody id="offline-pooja-package-dynamic-field">
                                        <tr>
                                            <td class="pt-0" style="width: 30%">
                                                <select class="form-control packageIdList" name="package_details[]"
                                                    id="package_details" required>
                                            ...
                                            <td class="pt-0" style="width: 10%;">
                                                <button type="button" id="offline-package-add" data-package-id=""
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <div>
                                            <label for="name"
                                                class="title-color text-capitalize font-weight-bold mb-0">{{ translate('pooja_thumbnail') }}</label>
                                            <span
            ...
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        <h4 class="mb-0">{{ translate('pooja_video') }}</h4>
                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
...
@push('script')
    ...
    <script>
        $(document).on('change', 'select[name="package_details[]"]', function() {
            ...
            $('select[name="packages_details[]"]').each(function() {
