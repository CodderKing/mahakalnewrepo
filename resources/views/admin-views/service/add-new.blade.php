                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" {{ $lang == $defaultLanguage ? 'required' : 'required' }} name="name[]"
                                        id="{{ $lang }}_name" class="form-control" placeholder="Pooja Name">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="title-color"for="{{ $lang }}_pooja_heading">{{ translate('pooja_heading') }}
                                        ({{ strtoupper($lang) }})
                                    </label>
                                    <input type="text" {{ $lang == $defaultLanguage ? 'required' : 'required' }}  name="pooja_heading[]" id="{{ $lang }}_pooja_heading"
                                        class="form-control" placeholder="{{ translate('pooja_name_special') }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="title-color"for="{{ $lang }}_short_benifits">{{ translate('short_benifits') }}
                                        ({{ strtoupper($lang) }})
                                    </label>
                                    <input type="text" {{ $lang == $defaultLanguage ? 'required' : 'required' }}  name="short_benifits[]" id="{{ $lang }}_short_benifits"
                                        class="form-control" placeholder="{{ translate('short_benifits') }}">
                                </div>
                               
                                <div class="form-group  col-md-6">
                                    <label class="title-color" for="{{ $lang }}_pooja_venue">{{ translate('pooja_venue') }} ({{ strtoupper($lang) }})</label>
                                    <input type="text" name="pooja_venue[]" id="{{ $lang }}_pooja_venue" class="form-control" placeholder="{{ translate('puja_venue') }}" {{ $lang == $defaultLanguage ? 'required' : 'required' }}>
                                </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="about-pooja-{{ $lang }}" role="tabpanel"
                                    aria-labelledby="about-pooja-{{ $lang }}-tab">
                                    <label class="title-color"
                                        for="{{ $lang }}_details">{{ translate('about_pooja') }}
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}" {{ $language == 'en' ? 'required' : 'required' }} name="details[]">{{ old('details') }}</textarea>
                                </div>
                                <div class="tab-pane fade" id="benefits-{{ $lang }}" role="tabpanel"
                                    ...
                                    <label class="title-color"
                                        ...
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}" {{ $language == 'en' ? 'required' : 'required' }} name="benefits[]">{{ old('benefits') }}</textarea>
                                </div>
                                <div class="tab-pane fade" id="process-{{ $lang }}" role="tabpanel"
                                    ...
                                    <label class="title-color"
                                        ...
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}"  {{ $language == 'en' ? 'required' : 'required' }} name="process[]">{{ old('process') }}</textarea>
                                </div>
                                <div class="tab-pane fade" id="temple-{{ $lang }}" role="tabpanel"
                                    ...
                                    <label class="title-color"
                                        ...
                                        ({{ strtoupper($lang) }})</label>
                                    <textarea class="ckeditor" id="editor{{ $lang }}" {{ $language == 'en' ? 'required' : 'required' }} name="temple_details[]">{{ old('temple_details') }}</textarea>
                                </div>
                            </div>
