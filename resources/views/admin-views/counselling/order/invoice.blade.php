                            ...
                            <tr>
                                <td>
                                        ...
                                        <div class="h4 montserrat-normal-600">
                                            <p class="mt-6 mb-0">Name: {{ !empty($details['counselling_user']['name'])?$details['counselling_user']['name']:'' }}</p>
                                            <p class="mt-6 mb-0">DOB: {{ !empty($details['counselling_user']['dob'])?$details['counselling_user']['dob']:'' }}</p>
                                            <p class="mt-6 mb-0">Birth Time: {{ !empty($details['counselling_user']['time'])?$details['counselling_user']['time']:'' }}</p>
                                            <p class="mt-6 mb-0">Country: {{ !empty($details['counselling_user']['country'])?$details['counselling_user']['country']:'' }}</p>
                                            <p class="mt-6 mb-0">City: {{ !empty($details['counselling_user']['city'])?$details['counselling_user']['city']:'' }}</p>
                                        </div>
                                </td>
                            </tr>
                        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-dashed-top font-weight-bold" style="width:100px;">
                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $details['payments']['payment_amount']), currencyCode: getCurrencyCode(type: 'default')) }}
                    </td>
                </tr>
            </tbody>
        </table>
