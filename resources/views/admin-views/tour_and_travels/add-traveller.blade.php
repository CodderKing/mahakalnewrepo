                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" required name="phone_no" class="form-control @error('phone_no') is-invalid @enderror onfillup" value="{{ old('phone_no') }}" placeholder="{{ translate('phone_number') }}" data-point='1'>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ifsc_code" class="form-control  @error('ifsc_code') is-invalid @enderror onfillup" value="{{ old('ifsc_code') }}" placeholder="{{ translate('IFSC_code') }}" data-point="9">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="confirm_account_number" class="form-control" placeholder="{{ translate('Account_number') }}" onkeyup="this.value = this.value.replace(/[^0-9]/g, '' );" onblur="validateAccountNumber();" required>
