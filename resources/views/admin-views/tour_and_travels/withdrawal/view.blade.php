                ...
                <div class="card-body">
                    <div class="row my-2">
                        ...
                        <div class="col-md-2 float-end">
                            <a href="{{ route('admin.tour_withdrawal.rejects',['id'=>$withdrawRequests['id']])}}" class="btn btn-danger">Rejected</a>
                        </div>
                        <div class="col-md-2 float-end">
                            <a href="{{ route('admin.tour_withdrawal.payment-req-approval-admin',['id'=>$withdrawRequests['id'],'type'=>'upi'])}}" class="btn btn-info">Approval UPI</a>
                        </div>
                        <div class="col-md-2 float-end">
                            <a href="{{ route('admin.tour_withdrawal.payment-req-approval-admin',['id'=>$withdrawRequests['id'],'type'=>'bank'])}}" class="btn btn-primary">Approval bank</a>
                        </div>
                        <div class="col-md-2 float-end">
                            <a onclick="$('.manual_forms').toggleClass('d-none')" class="btn btn-primary">Approval Manual</a>
                            <form class="d-none manual_forms" action="{{ route('admin.tour_withdrawal.payment-req-approval-admin',['id'=>$withdrawRequests['id'],'type'=>'manual'])}}" method="get">
