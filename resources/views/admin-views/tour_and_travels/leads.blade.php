...
<div class="content container-fluid">
    <div class="mb-3">
        <h2 class="h1 mb-0 d-flex gap-2">
            ...
            <span class="badge badge-soft-dark radius-50 fz-14">{{ $Tourlist->total() }}</span>
        </h2>
    </div>
    <div class="row mt-20">
        <div class="col-md-12">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table
                            ...
                            <tbody>
                                @foreach($Tourlist as $key => $lead)
                                                <tr>
                                                    <td>{{ $Tourlist->firstItem() + $key }}</td>
                                                    <td> {{ ($lead['userData']['name'] ?? "") }} <br>
                                                    {{ ($lead['userData']['phone'] ?? "") }}</td>
                                            
                                                    <td> {{ ($lead['Tour']['tour_name'] ?? "") }}<br>
                                            ...
                                            <td>{{ $lead['followby']['last_date'] ?? 'pending'}}</td>
                                                    <td class="text-center">
                                                        ...
                                                        <div class="d-flex justify-content-center gap-2">
                                                            ...
                                                            <a href="{{ route('admin.tour_visits.leads-delete', [$lead['id']]) }}"
                                                            ...
                                                            <a href="javascript:void(0)"
                                                                ...
                                                                data-custId="{{ $lead['user_id'] }}" data-leadsId="{{ $lead['id'] }}"
...
<div class="modal fade" id="followUpModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.tour_visits.tour-follow-up') }}" method="POST">
                @csrf
                @php
                    if (auth('admin')->check()) {
