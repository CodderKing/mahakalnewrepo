                                ...
                                <tr>
                                                                                    ...
                                                                                    if ($lead['use_date'] == 0 || ($p_info['type'] == 'cab' && $lead['use_date'] == 1) || ($p_info['type'] != 'ex_distance' && $lead['use_date'] == 2) || ($lead['type'] != 'ex_distance' && $lead['use_date'] == 3) || ($p_info['type'] != 'ex_distance' && $lead['use_date'] == 4)) { ?>
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                } elseif ($p_info['type'] == 'other' || $p_info['type'] == 'foods' || $p_info['type'] == 'food' || $p_info['type'] == 'hotel') {
                                                                                                ...
                                                                                                <div class="col-3 text-left">
                                                                                                    ...
                                                                                                    <?php } elseif ($p_info['type'] == 'other' || $p_info['type'] == 'foods' || $p_info['type'] == 'food' || $p_info['type'] == 'hotel') { ?>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <small
                                                class="btn btn-sm btn-warning text-white">{{ $lead['part_payment'] == 'full' ? $lead['part_payment'] : 'partially' }}</small>
                                        </div>
                                    </td>
