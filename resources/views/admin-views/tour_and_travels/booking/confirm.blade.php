...
<div class="content container-fluid">
    <div class="row">
        <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
            ...
            <a class="order-stats order-stats_confirmed"  href="{{ route('admin.tour-visits-booking.confirm-booking') }}">
                <div class="order-stats__content">
                    <i class="tio-all_done">all_done</i>
                    <h6 class="order-stats__subtitle">{{ translate('Total_confirm_order')}}</h6>
                </div>
                <span class="order-stats__title">
                    @php
                    echo \App\Models\tourOrder::where('status', 1)->where('amount_status',1)->where('cab_assign','!=',0)->whereIn('pickup_status',[0,1])->where('drop_status',0)->count();
                    @endphp
                </span>
            </a>
        </div>
        <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
            <a class="order-stats order-stats_confirmed" href="{{ route('admin.tour-visits-booking.confirm-booking',['pickup_status'=>'one']) }}">
                <div class="order-stats__content">
                    <i class="tio-all_done">all_done</i>
                    <h6 class="order-stats__subtitle">{{ translate('confirm_order')}}</h6>
                </div>
                <span class="order-stats__title">
                    @php
                    echo \App\Models\tourOrder::where('status', 1)->where('amount_status',1)->where('cab_assign','!=',0)->where('pickup_status',0)->where('drop_status',0)->count();
                    @endphp
                </span>
            </a>
        </div>
        <div class="col-sm-6 col-lg-3 col-md-3 mt-2">
            <a class="order-stats order-stats_confirmed" href="{{ route('admin.tour-visits-booking.confirm-booking',['pickup_status'=>'two']) }}">
                <div class="order-stats__content">
                    <i class="tio-all_done">all_done</i>
                    <h6 class="order-stats__subtitle">{{ translate('pickup_customer')}}</h6>
                </div>
                <span class="order-stats__title">
                    @php
                    echo \App\Models\tourOrder::where('status', 1)->where('amount_status',1)->where('cab_assign','!=',0)->where('pickup_status',1)->where('drop_status',0)->count();
                    @endphp
                </span>
            </a>
        </div>
