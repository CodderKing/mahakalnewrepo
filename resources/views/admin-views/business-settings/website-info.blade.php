...
@section('content')
    <div class="content container-fluid">
        ...
        @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'general-maintance-mode'))
        <div class="card mb-3">
            <div class="card-body">
        ...
        <form action="{{ route('admin.business-settings.web-config.update') }}" method="POST"
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{dynamicAsset(path: 'public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{translate('Email_top_bar')}}
                            </h5>
                            <span class="badge badge-soft-info">{{'('.'100X60'.'px'.')'}}</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-email_top_bar" src="{{ getValidImage(path: 'storage/app/public/company/'. ($businessSetting['email_top_bar']??'') , type: 'backend-basic') }}" alt="">
                            </div>
                            <div class="mt-4 position-relative">
                                <input type="file" name="email_top_bar" id="email_top_bar" class="custom-file-input image-input" data-image-id="view-email_top_bar" accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label text-capitalize" for="email_top_bar">{{translate('choose_file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{dynamicAsset(path: 'public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{translate('Email_Bottom_bar')}}
                            </h5>
                            <span class="badge badge-soft-info">{{'('.'100X60'.'px'.')'}}</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-email_bottom_bar"
                                     src="{{ getValidImage(path: 'storage/app/public/company/'. ($businessSetting['email_bottom_bar']??'') , type: 'backend-basic') }}" alt="">
                            </div>
                            <div class="mt-4 position-relative">
                                <input type="file" name="email_bottom_bar" id="email_bottom_bar"
                                       class="custom-file-input image-input" data-image-id="view-email_bottom_bar"
                                       accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label text-capitalize"
                                       for="email_bottom_bar">{{translate('choose_file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if (Helpers::modules_permission_check('Business Setup', 'Business Setting', 'general-save'))
