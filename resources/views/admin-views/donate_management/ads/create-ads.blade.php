                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-2 set_types_display {{ ((old('type') == 'outsite')?'':'d-none')}}">
                                        ...
                                        <div class="col-md-4 mt-2 set_types_display {{ ((old('type') == 'outsite')?'':'d-none')}}">
                                                    ...
                                                    <input type="text" name="admin_commission"  value="{{ old('admin_commission')}}" class="form-control fillupdata" data-point='4' onblur="$(`.fillupdata[data-point='4']`).val(this.value)" id="{{$lang}}_admin_commission">
                                                </div>
                                        <div class="col-md-4">
